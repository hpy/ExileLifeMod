/**
                    ...
                    */
                    ...
                    forEach
                    [
                    	['ExileServer_object_animal_event_onKilled', 'exile_server\code\ExileServer_object_animal_event_onKilled.sqf'],
	['ExileServer_object_animal_network_announceAnimalRequest', 'exile_server\code\ExileServer_object_animal_network_announceAnimalRequest.sqf'],
	['ExileServer_object_animal_network_gutAnimalRequest', 'exile_server\code\ExileServer_object_animal_network_gutAnimalRequest.sqf'],
	...
	['ExileServer_object_lock_network_grindLockRequest', 'exile_server\code\ExileServer_object_lock_network_grindLockRequest.sqf'],
	['ExileServer_object_lock_network_grindNotificationRequest', 'exile_server\code\ExileServer_object_lock_network_grindNotificationRequest.sqf'],
	['ExileServer_object_lock_network_hackLockRequest', 'exile_server\code\ExileServer_object_lock_network_hackLockRequest.sqf'],
	...
	['ExileServer_object_lock_network_startHackRequest', 'exile_server\code\ExileServer_object_lock_network_startHackRequest.sqf'],
	['ExileServer_object_lock_network_updateHackAttemptRequest', 'exile_server\code\ExileServer_object_lock_network_updateHackAttemptRequest.sqf'],
	...
	['ExileServer_object_player_network_tagSpectateRequest', 'exile_server\code\ExileServer_object_player_network_tagSpectateRequest.sqf'],
	...
	['ExileServer_object_vehicle_database_loadFromVirtualGarage', 'exile_server\code\ExileServer_object_vehicle_database_loadFromVirtualGarage.sqf'],
	...
	['ExileServer_object_vehicle_network_retrieveVehicleRequest', 'exile_server\code\ExileServer_object_vehicle_network_retrieveVehicleRequest.sqf'],
	...
	['ExileServer_object_vehicle_network_storeVehicleRequest', 'exile_server\code\ExileServer_object_vehicle_network_storeVehicleRequest.sqf'],
	...
	['ExileServer_system_escape_deathCheck', 'exile_server\code\ExileServer_system_escape_deathCheck.sqf'],
	['ExileServer_system_escape_deleteVehicles', 'exile_server\code\ExileServer_system_escape_deleteVehicles.sqf'],
	['ExileServer_system_escape_extractionHeli', 'exile_server\code\ExileServer_system_escape_extractionHeli.sqf'],
	['ExileServer_system_escape_extractionHeliHover', 'exile_server\code\ExileServer_system_escape_extractionHeliHover.sqf'],
	['ExileServer_system_escape_extractionHeliTakeoff', 'exile_server\code\ExileServer_system_escape_extractionHeliTakeoff.sqf'],
	['ExileServer_system_escape_findSafePositions', 'exile_server\code\ExileServer_system_escape_findSafePositions.sqf'],
	['ExileServer_system_escape_initialize', 'exile_server\code\ExileServer_system_escape_initialize.sqf'],
	['ExileServer_system_escape_lockServer', 'exile_server\code\ExileServer_system_escape_lockServer.sqf'],
	['ExileServer_system_escape_playerCountCheck', 'exile_server\code\ExileServer_system_escape_playerCountCheck.sqf'],
	['ExileServer_system_escape_playerStart', 'exile_server\code\ExileServer_system_escape_playerStart.sqf'],
	['ExileServer_system_escape_randomizeWeather', 'exile_server\code\ExileServer_system_escape_randomizeWeather.sqf'],
	['ExileServer_system_escape_shrinkFinalArea', 'exile_server\code\ExileServer_system_escape_shrinkFinalArea.sqf'],
	['ExileServer_system_escape_spawnLoot', 'exile_server\code\ExileServer_system_escape_spawnLoot.sqf'],
	['ExileServer_system_escape_startGame', 'exile_server\code\ExileServer_system_escape_startGame.sqf'],
	['ExileServer_system_escape_teleport', 'exile_server\code\ExileServer_system_escape_teleport.sqf'],
	['ExileServer_system_escape_updateArea', 'exile_server\code\ExileServer_system_escape_updateArea.sqf'],
	['ExileServer_system_escape_waitForPlayers', 'exile_server\code\ExileServer_system_escape_waitForPlayers.sqf'],
	['ExileServer_system_escape_weaponBoxes', 'exile_server\code\ExileServer_system_escape_weaponBoxes.sqf'],
	['ExileServer_system_escape_winning', 'exile_server\code\ExileServer_system_escape_winning.sqf'],
	['ExileServer_system_escape_3dzone_create', 'exile_server\code\ExileServer_system_escape_3dzone_create.sqf'],
	['ExileServer_system_escape_3dzone_destroy', 'exile_server\code\ExileServer_system_escape_3dzone_destroy.sqf'],
	['ExileServer_system_escape_thread_spawn', 'exile_server\code\ExileServer_system_escape_thread_spawn.sqf'],
	...
	['ExileServer_system_event_escapeSupplyBox_start', 'exile_server\code\ExileServer_system_event_escapeSupplyBox_start.sqf'],
