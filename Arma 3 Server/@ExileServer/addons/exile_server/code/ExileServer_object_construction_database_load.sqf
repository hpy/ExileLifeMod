/**
                    ...
                    */
                    ...
                    private["_constructionID","_data","_position","_vectorDirection","_vectorUp","_constructionObject","_damageLevel","_public","_pinCode","_globalSimulationObjects"];
...
{
	_globalSimulationObjects = getArray(missionConfigFile >> "CfgSimulation" >> "enableGlobalSimulation");
	if (getNumber(missionConfigFile >> "CfgSimulation" >> "enableDynamicSimulation") isEqualTo 1) then
	{
		if ((typeOf _constructionObject) in _globalSimulationObjects)then
		{
