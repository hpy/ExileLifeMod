/**
                    ...
                    */
                    ...
                    private["_sessionID","_parameters","_object","_playerObject","_maxRange","_flags","_buildRights","_lastAttackedAt","_constructionBlockDuration","_objectConfig","_objectClass","_position","_vectorUp","_vectorDir","_objectDatabaseID","_objectOwner","_objectPID","_accessCode","_newObject"];
...
try
{
 	...
 	if (_objectConfig isEqualTo []) then 
	{
 	...
 	_objectPID = _object getVariable ["ExileLifeOwnerPID",-1];
 	if (_objectDatabaseID isEqualTo 0) then 
	{
 	...
 	_newObject setVariable ["ExileLifeOwnerPID",_objectPID];
