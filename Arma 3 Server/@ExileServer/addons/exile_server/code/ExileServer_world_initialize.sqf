...
format ["Local Client Check Thread Started: %1",diag_ticktime] call ExileServer_util_log;
call ExileLifeServer_system_prison_thread_initialize;
ExileLifeDebug = true;
ExileLifeDisableBuildings = true;
"Loading Map Objects!" call ExileServer_util_log;
call ExileLifeServer_world_objects_init;
