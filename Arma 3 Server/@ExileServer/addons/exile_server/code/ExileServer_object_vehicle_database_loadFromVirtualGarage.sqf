/**
                    * ExileServer_object_vehicle_database_loadFromVirtualGarage
                    *
                    * Exile Mod
                    * www.exilemod.com
                    * © 2016 Exile Mod Team
                    ...
                    */
                    ...
                    private["_vehicleID","_data","_position","_vectorDirection","_vectorUp","_pinCode","_texture","_newPosition","_vehicleObject","_isLocked","_hitpoints","_cargoContainers"];
_vehicleID = _this;
...
_newPosition = [_position, 0, 50, 0.1] call BIS_fnc_findSafePos;
_newPosition set [2, (_position select 2)];
_vehicleObject = [(_data select 1), _newPosition, [_vectorDirection, _vectorUp], true,_pinCode] call ExileServer_object_vehicle_createPersistentVehicle;
...
_isLocked = ((_data select 4) isEqualTo -1);
if (_isLocked) then
{
...
if (((_newPosition distance _position) > 10)) then 
{
	_vehicleObject call ExileServer_object_vehicle_database_update;
};
[((_newPosition distance _position) > 10), _newPosition]