...
try
{
	...
	format["updateLocker:%1:%2%3", _newLockerAmount, getPlayerUID _player, _player getVariable ["ExileLifePID",-1]] call ExileServer_system_database_query_fireAndForget;
	_playerMoney = _player getVariable ["ExileMoney",0];
	_newPlayerMoney = _playerMoney + _withdrawAmount;
	_player setVariable ["ExileMoney", _newPlayerMoney, true];
	format["setPlayerMoney:%1:%2", _newPlayerMoney, _player getVariable ["ExileLifePID", -1]] call ExileServer_system_database_query_fireAndForget;
