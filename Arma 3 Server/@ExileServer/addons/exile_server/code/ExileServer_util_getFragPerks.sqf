/**
                    ...
                    */
                    ...
                    private["_victim","_killer","_killingPlayer","_perks","_victimGang","_killerGang","_victimPosGangTerritory","_lastKillAt","_killStack","_lastVictims","_victimUID","_flagNextToKiller","_flagNextToVictim","_vehicle","_vehicleRole","_distance","_distanceBonus"];
...
if ((_killerGang isEqualTo "Rogue") && (_victimPosGangTerritory isEqualTo _victimGang)) then 
{
	_perks pushBack ["BadAss", getNumber (configFile >> "CfgSettings" >> "Respect" >> "Frags" >> "badass")];
};
if ((currentWeapon _killingPlayer) isKindOf ["ExileLife_Weapon_Taser", configFile >> "CfgWeapons"]) then
{
	_perks pushBack ["He got PWND!", (getNumber (configFile >> "CfgSettings" >> "Respect" >> "Frags" >> "pwnd"))];
};
