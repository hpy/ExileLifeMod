/**
                    ...
                    */
                    ...
                    private["_sessionID","_parameters","_clanName","_player","_alphabet","_forbiddenCharacter","_registrationFee","_playerMoney","_gangBankBalance","_newgangBankBalance","_playerUid","_clanID","_hashValue"];
...
try
{
	...
	_gangBankBalance = missionNamespace getVariable ["Guard_ExileLifeGangBank",-1];
	_newgangBankBalance = _gangBankBalance + _registrationFee;
	missionNamespace setVariable ["Guard_ExileLifeGangBank",_newgangBankBalance];
	format["updateGangBank:%1:%2",_newgangBankBalance,"Guard"] call ExileServer_system_database_query_fireAndForget;
	_playerUid = getPlayerUID _player;
	_clanID = format["createClan:%1:%2:%3", _playerUid, _clanName,_player getVariable ["ExileLifePID",-1]] call ExileServer_system_database_query_insertSingle;
	_hashValue =
	[
		_clanName,		
		_playerUid,		
		...
		[],			
		grpNull,
		_player getVariable ["ExileLifePID",-1]		
	];
	missionNameSpace setVariable [format ["ExileServer_clan_%1",_clanID],_hashValue];
	format["setAccountClanLink:%1:%2:%3", _clanID, getPlayerUID _player, _player getVariable ["ExileLifePID",-1]] call ExileServer_system_database_query_fireAndForget;
