/**
                    ...
                    */
                    ...
                    private["_sessionID","_parameters","_hunger","_thirst","_alcohol","_temperature","_wetness","_gasMaskTimeLeft","_player"];
...
_gasMaskTimeLeft = _parameters select 5;
...
if (!isNull _player) then
{
	...
	_player setVariable ["ExileLifeGasMaskTimeLeft", _gasMaskTimeLeft];
