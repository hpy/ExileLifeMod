...
try
{
	...
	if !(_victim isKindOf "Exile_Unit_Player" || _victim isKindOf "ExileLife_Unit_Guard") then
	{
	...
	_hostageTaker setVariable ["ExileLifeisEscortingChk", false, true];
	...
	format["setAccountScore:%1:%2", _newScore, _hostageTaker getVariable ["ExileLifePID", -1]] call ExileServer_system_database_query_fireAndForget;
}
catch
{
