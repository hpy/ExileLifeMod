/**
                    ...
                    */
                    ...
                    private["_sessionID","_requestedKickPlayerUID","_player","_clanID","_clanHash","_clanMembers","_index","_memberName","_kickingPlayerObject","_kickPlayer"];
...
try
{
	...
	_kickingPlayerObject = (_requestedKickPlayerUID call ExileLifeServer_system_session_getIDfromUID) call ExileServer_system_session_getPlayerObject;
	format["unLinkClanLink:%1:%2", _requestedKickPlayerUID, _kickingPlayerObject getVariable ["ExileLifePID",-1]] call ExileServer_system_database_query_fireAndForget;
