/**
                    * ExilelifeServer_system_allowance_network_prisonAllowanceWithdrawalRequest
                    *
                    * Exile Mod
                    * www.exilemod.com
                    * © 2016 Exile Mod Team
                    ...
                    */
                    ...
                    private["_sessionID","_player","_playersGang","_playerID","_playerPrisonAllowanceToCollect","_playerMoney","_newPlayerMoney"];
...
try
{
	...
	format["updatePlayersPrisonAllowance:%1:%2", 0,_playerID] call ExileServer_system_database_query_fireAndForget;
	_playerMoney = _player getVariable ["ExileMoney",0];
	_newPlayerMoney = _playerMoney + _playerPrisonAllowanceToCollect;
