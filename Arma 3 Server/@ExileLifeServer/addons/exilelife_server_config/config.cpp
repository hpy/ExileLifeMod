...
class CfgExileLifePermissions
{
    class Developer
    {
        ...
        {
/*
	The main permission file for ExileLife Admin Tools
	This file controls certain aspects of the tools that are outside the "Functions" list
	If you are unsure what to do in this file, you shouldn't be editing it... :P
	Talk to WolfkillArcadia if you have any questions
*/
/*
	allowTargetAdministration
	Controls if the user can see and use the "Target" button in their players panel
	OPTIONS:
		1 - Enabled
		0 - Disabled
*/
allowTargetAdministration = 1;
/*
	targetAdministrationOptions
	Controls what options show up in the Target Administration menu that the user can modify
	It can be any combination of the following options in any order.
	NOTE: This option is only used when allowTargetAdministration is set to 1
	EXTRA NOTE: Make sure the options are comma separated and the last option doesn't end with a comma
	OPTIONS:
		"Poptabs (Player)",
		"Poptabs (Locker)",
		"Respect"
...
/*
	allowServerAdministration
	Controls if the user can see and use the "Server" button in their players panel
	OPTIONS:
		1 - Enabled
		0 - Disabled
*/
allowServerAdministration = 1;
/*
	serverAdministrationOptions
	Controls what options show up in the Server Administration menu that the user can do to a player
	It can be any combination of the following options in any order.
	NOTE: This option is only used when allowServerAdministration is set to 1
	EXTRA NOTE: Make sure the options are comma separated and the last option doesn't end with a comma
	OPTIONS:
		"Warn (Silent)",
		"Warn (Announce)",
...
/*
	vehicleSpawnOptions
	Controls what options show up in the Vehicle Spawn type menu
	It can be any combination of the following options in any order.
	NOTE: This option is only used when the user has access to vehicle or vehicleExileLife
	EXTRA NOTE: Make sure the options are comma separated and the last option doesn't end with a comma
	OPTIONS:
		"Non-Persistent",
		"Persistent"
...
/*
	allowTargetInformationKeybind
	Controls if the user has access to the Target Information Keybind (Default key: 6)
	OPTIONS:
		1 - Enabled
		0 - Disabled
*/
allowTargetInformationKeybind = 1;
/*
	allowLockUnlockKeybind
	Controls if the user has access to the Lock/Unlock Keybind (Default key: 7)
	OPTIONS:
		1 - Enabled
		0 - Disabled
*/
allowLockUnlockKeybind = 1;
/*
	allowFlipVehicleKeybind
	Controls if the user has access to the Flip Vehicle Keybind (Default key: F4)
	OPTIONS:
		1 - Enabled
		0 - Disabled
*/
allowFlipVehicleKeybind = 1;
/*
	allowDeleteObjectKeybind
	Controls if the user has access to the Delete Object Keybind (Default key: DELETE)
	OPTIONS:
		1 - Enabled
		0 - Disabled
*/
allowDeleteObjectKeybind = 1;
        };
        class Functions
        {
class Toggles
{
    ...
    {
        name = "GodMode";
        actVar = "GodMode_Enabled";
    };
    class VehicleGodmode
    {
        name = "Vehicle GodMode";
        actVar = "Vehicle_GodMode_Enabled";
    };
    class MapTP
    {
        name = "Map TP";
        actVar = "Map_TP_Enabled";
    };
    class ForwardTP
    {
        name = "Forward TP";
        actVar = "Forward_TP_Enabled";
    };
    class Jump
    {
        name = "Jump";
    ...
    {
        name = "------";
        color[] = {0.275,0.494,0.565,1};
    };
    /////////////////////////////////////////////////
    class ESP_player
    {
        name = "ESP (Player)";
        actVar = "Player_ESP_Enabled";
    };
    class ESP_ai
    {
        name = "ESP (AI)";
        actVar = "AI_ESP_Enabled";
    };
    class ESP_loot
    {
        name = "ESP (Loot)";
        actVar = "Loot_ESP_Enabled";
    };
    class ESP_vehicles
    {
        name = "ESP (Vehicles)";
        actVar = "Vehicles_ESP_Enabled";
    };
    class ESP_house
    {
        name = "ESP (House)";
        actVar = "House_ESP_Enabled";
        exilelifeServer = 1;
    };
    class MapIcons_players
    {
        name = "Map Icons (Players)";
        actVar = "Map_Icons_Players_Enabled";
    };
    class MapIcons_deadPlayers
    {
        name = "Map Icons (Dead Players)";
        actVar = "Map_Icons_Dead_Players_Enabled";
    };
    class MapIcons_ai
    {
        name = "Map Icons (AI)";
        actVar = "Map_Icons_AI_Enabled";
    };
    class MapIcons_vehicles
    {
        name = "Map Icons (Vehicles)";
        actVar = "Map_Icons_Vehicles_Enabled";
    };
    class MapIcons_house
    {
        name = "Map Icons (House)";
        actVar = "Map_Icons_House_Enabled";
        exilelifeServer = 1;
    };
    /////////////////////////////////////////////////
    class Spacer1
    ...
    {
        name = "Infinite Ammo";
        actVar = "Infinite_Ammo_Enabled";
    };
    class Invisibility
    {
        name = "Invisibility";
        actVar = "Invisibility_Enabled";
    };
    class NoRecoil
    {
        name = "No Recoil";
        actVar = "No_Recoil_Enabled";
    };
    class FastFire
    {
        name = "Fast Fire";
        actVar = "Fast_Fire_Enabled";
    };
    class DisableFatigue
    {
        name = "Disable Fatigue";
        actVar = "Disable_Fatigue_Enabled";
    };
};
class Self
{
    ...
    */
    class SelfDisconnect
    {
        name = "Self - Disconnect";
    };
};
class Target
{
    ...
    filePrefix = "target";
    /////////////////////////////////////////////////
    class Teleport_toTarget
    {
        name = "Teleport To Target";
        color[] = {0.208,0.431,0.376,1};
    };
    class Teleport_toMe
    {
    ...
    class Vehicle_moveIn
    {
        name = "Move into Target's Vehicle";
        color[] = {0.208,0.431,0.376,1};
    };
    class Vehicle_moveTo
    {
        name = "Move Target into Vehicle";
        color[] = {0.208,0.431,0.376,1};
    };
    class Heal
    {
    ...
    class Vehicle_ejectCrew
    {
        name = "Eject Target's Crew";
        color[] = {0.635,0.306,0.384,1};
    };
    /////////////////////////////////////////////////
    class Spacer1
...
class Spawn
{
    ...
    class VehiclesExileLife
    {
        name = "Vehicles (Exile Life)";
        option = 9;
    };
    class UniformsVests
    {
...
class Spawn
{
    ...
    class TrialModerator
    {
    	displayName = "Trial Moderator";
        class Permissions
        {
/*
	The main permission file for ExileLife Admin Tools
...
/*
	...
	OPTIONS:
		...
		0 - Disabled
*/
allowTargetInformationKeybind = 0;
/*
	allowLockUnlockKeybind
	Controls if the user has access to the Lock/Unlock Keybind (Default key: 7)
	OPTIONS:
...
class CfgExileLifeServerSettings
{
    ...
    class Time
    {
        ...
        useStaticTime = 0;
        // Will use time saved at last shutdown (if no time saved then uses static time)
        useSavedTime = 1;
        // time in ARMA FORMAT << CONFIG
        // https://community.bistudio.com/wiki/setDate
        staticTime[] = {2039,10,24,12,30};
        //Turn day/night time multiplier on
        useTimeMultiplier = 1;
        //setting these to not eaqual amount of time server is up means that the time in game
        //will not be the same in realworld time each day!
        //Speedup days
        daytimeMultiplier = 4;
        //Speedup nights
        nighttimeMultiplier = 15;
    };
};
class CfgExileLootServer
{
	class LootTables
	{
		/*
			...
			Trash             = 15.96%
		*/
		CivillianLowerClass[] = {"CivilianHeadgear", "Drinks", "Chemlights", "Shotguns", "CivilianClothing", "CivilianVests", "Trash", "Food", "CivilianBackpacks", "Trash", "CivilianVests", "CivilianBackpacks", "RoadFlares", "Food", "Trash", "SMG", "Trash", "SMG", "CivilianHeadgear", "CivilianHeadgear", "CivilianItems", "Drinks", "Food", "CivilianHeadgear", "Food", "CivilianHeadgear", "Chemlights", "RoadFlares", "Pistols", "PistolAmmo", "SMGAmmo", "CivilianClothing", "Food", "ShotgunAmmo", "RoadFlares", "SMGAttachments", "Food", "Trash", "CivilianHeadgear", "Drinks", "Trash", "CivilianHeadgear", "CivilianBackpacks", "Chemlights", "Chemlights", "Food", "CivilianClothing", "Food", "Trash", "RoadFlares", "Food", "SMGAttachments", "Food", "CivilianHeadgear", "Food", "CivilianClothing", "Trash", "Food", "CivilianHeadgear", "CivilianBackpacks", "Trash", "SMG", "Chemlights", "CivilianClothing", "CivilianClothing", "Trash", "CivilianHeadgear", "PistolAmmo", "SMG", "Chemlights", "Trash", "CivilianClothing", "CivilianClothing", "Pistols", "Food", "CivilianBackpacks", "RoadFlares", "Food", "CivilianHeadgear", "Drinks", "Food", "Trash", "CivilianItems", "RoadFlares", "CivilianBackpacks", "Food", "Chemlights", "Food", "CivilianClothing", "Food", "Food", "Pistols", "Trash", "Trash", "CivilianClothing", "CivilianClothing", "Food", "CivilianBackpacks", "Trash", "Drinks", "CivilianHeadgear", "CivilianClothing", "CivilianItems", "Food", "Shotguns", "CivilianItems", "Trash", "Trash", "Trash", "CivilianHeadgear", "CivilianBackpacks", "CivilianClothing", "CivilianClothing", "CivilianClothing", "CivilianHeadgear", "Trash", "CivilianClothing", "Trash", "CivilianClothing", "CivilianVests", "CivilianHeadgear", "Pistols", "CivilianItems", "Trash", "Trash", "ShotgunAmmo", "CivilianItems", "Pistols", "RoadFlares", "Restraints", "SMGAmmo", "CivilianBackpacks", "Food", "Food", "CivilianClothing", "PistolAttachments", "CivilianItems", "Food", "Pistols", "PistolAmmo", "RoadFlares", "Drinks", "CivilianClothing", "Trash", "Food", "Trash", "Drinks", "CivilianHeadgear", "PistolAttachments", "Trash", "CivilianBackpacks", "CivilianHeadgear", "RoadFlares", "PistolAmmo", "PistolAmmo", "Shotguns", "Food", "Food", "Chemlights", "Trash", "CivilianHeadgear", "SMGAmmo", "Trash", "PistolAttachments", "CivilianVests", "Chemlights", "CivilianItems", "Pistols", "CivilianHeadgear", "CivilianItems", "CivilianClothing", "Trash", "Pistols", "CivilianItems", "Drinks", "CivilianVests", "Trash", "RoadFlares", "CivilianHeadgear", "Food", "CivilianBackpacks", "Shotguns", "Drinks", "SMGAttachments", "ShotgunAmmo", "Chemlights", "Trash", "Drinks"};
		/*
			Percental Item Group Spawn Chances of CivillianUpperClass:
			Restraints        = 0.51%
			...
			Trash             = 15.23%
		*/
		CivillianUpperClass[] = {"Food", "Drinks", "CivilianVests", "Chemlights", "RoadFlares", "CivilianBackpacks", "Food", "PistolAttachments", "CivilianHeadgear", "CivilianItems", "CivilianHeadgear", "Drinks", "Food", "Drinks", "Trash", "SMGAttachments", "Pistols", "PistolAmmo", "CivilianClothing", "RoadFlares", "CivilianItems", "PistolAmmo", "Shotguns", "CivilianClothing", "CivilianHeadgear", "CivilianVests", "RifleAmmo", "Food", "Trash", "Trash", "Drinks", "Food", "RoadFlares", "SMGAmmo", "Drinks", "Drinks", "Trash", "Food", "Trash", "CivilianClothing", "RifleAttachments", "CivilianClothing", "Food", "Chemlights", "Trash", "CivilianVests", "CivilianClothing", "CivilianClothing", "CivilianBackpacks", "CivilianHeadgear", "Food", "CivilianHeadgear", "RoadFlares", "SMG", "RifleAttachments", "CivilianClothing", "Trash", "Food", "PistolAttachments", "ShotgunAmmo", "Trash", "RifleAmmo", "Trash", "Chemlights", "CivilianHeadgear", "Chemlights", "Trash", "SMG", "CivilianItems", "Food", "Pistols", "Trash", "SMGAmmo", "Food", "PistolAmmo", "Food", "Food", "Trash", "CivilianClothing", "SMGAttachments", "Restraints", "Chemlights", "RoadFlares", "Pistols", "Food", "CivilianClothing", "CivilianClothing", "Trash", "CivilianClothing", "Food", "CivilianHeadgear", "Pistols", "Trash", "Pistols", "CivilianClothing", "CivilianItems", "CivilianHeadgear", "CivilianHeadgear", "Shotguns", "CivilianItems", "CivilianClothing", "RoadFlares", "Food", "CivilianBackpacks", "CivilianClothing", "ShotgunAmmo", "CivilianBackpacks", "CivilianItems", "Shotguns", "Trash", "RoadFlares", "Trash", "Trash", "CivilianItems", "RoadFlares", "RifleAttachments", "Food", "CivilianClothing", "Food", "RifleAmmo", "CivilianHeadgear", "Food", "Trash", "Food", "CivilianHeadgear", "CivilianHeadgear", "CivilianBackpacks", "ShotgunAmmo", "Chemlights", "CivilianHeadgear", "Pistols", "Chemlights", "CivilianClothing", "Trash", "Trash", "Food", "CivilianBackpacks", "CivilianClothing", "Drinks", "SMG", "Pistols", "CivilianHeadgear", "CivilianBackpacks", "Shotguns", "Food", "PistolAmmo", "CivilianVests", "Food", "CivilianBackpacks", "SMGAmmo", "CivilianItems", "CivilianHeadgear", "CivilianHeadgear", "Food", "Rifles", "CivilianHeadgear", "Food", "CivilianHeadgear", "CivilianBackpacks", "CivilianClothing", "Chemlights", "SMG", "CivilianBackpacks", "Trash", "Pistols", "Rifles", "Drinks", "CivilianBackpacks", "Food", "Chemlights", "CivilianVests", "Trash", "CivilianHeadgear", "Trash", "PistolAttachments", "Drinks", "CivilianHeadgear", "Trash", "Food", "Drinks", "Trash", "SMGAttachments", "Chemlights", "Trash", "CivilianClothing", "CivilianClothing", "Trash", "PistolAmmo", "Trash", "Food", "Rifles", "Trash", "Trash", "CivilianItems", "RoadFlares", "CivilianItems", "RoadFlares"};
		/*
			Percental Item Group Spawn Chances of Shop:
			...
			Trash             = 24.00%
		*/
		Shop[] = {"Pistols", "Trash", "Trash", "ShotgunAmmo", "Chemlights", "CivilianBackpacks", "SMG", "Trash", "Restraints", "Chemlights", "Food", "Drinks", "Trash", "Drinks", "Drinks", "RoadFlares", "Food", "Trash", "Food", "Trash", "SMG", "Drinks", "Trash", "CivilianHeadgear", "RoadFlares", "CivilianItems", "Pistols", "Trash", "Shotguns", "Pistols", "Drinks", "SMG", "SMGAttachments", "CivilianItems", "Food", "RoadFlares", "Trash", "Trash", "CivilianItems", "CivilianItems", "Trash", "Food", "Food", "Trash", "RoadFlares", "Shotguns", "Food", "CivilianItems", "SMG", "Food", "Trash", "Trash", "Pistols", "Restraints", "PistolAttachments", "Drinks", "Trash", "CivilianClothing", "Trash", "Pistols", "MedicalItems", "Trash", "Trash", "Pistols", "IndustrialItems", "Trash", "Food", "SMG", "RoadFlares", "CivilianItems", "Trash", "Food", "CivilianBackpacks", "Shotguns", "CivilianBackpacks", "Pistols", "Trash", "Trash", "Chemlights", "Food", "Drinks", "CivilianBackpacks", "IndustrialItems", "Drinks", "Trash", "PistolAmmo", "Food", "Pistols", "CivilianHeadgear", "CivilianBackpacks", "Chemlights", "Drinks", "SmokeGrenades", "MedicalItems", "Drinks", "Trash", "Food", "Trash", "Trash", "Trash", "Pistols", "SmokeGrenades", "CivilianVests", "IndustrialItems", "Drinks", "Food", "Pistols", "Drinks", "SMGAmmo", "Restraints", "Trash", "Drinks", "Food", "Shotguns", "CivilianItems", "CivilianHeadgear", "SmokeGrenades", "PistolAmmo", "Drinks", "Chemlights", "SmokeGrenades", "MedicalItems", "Trash", "Drinks", "Trash"};
		/*
			Percental Item Group Spawn Chances of Industrial:
			Restraints      = 4.35%
			RoadFlares      = 13.04%
		...
		*/
		Industrial[] = {"Restraints", "Trash", "Trash", "Trash", "Vehicle", "Vehicle", "IndustrialItems", "RoadFlares", "Trash", "RoadFlares", "Trash", "Vehicle", "IndustrialItems", "Vehicle", "IndustrialItems", "Vehicle", "IndustrialItems", "IndustrialItems", "IndustrialItems", "IndustrialItems", "RoadFlares", "Trash", "IndustrialItems"};
		/*
			Percental Item Group Spawn Chances of Factories:
			Electronics     = 10.00%
			Trash           = 40.00%
		...
		*/
		Factories[] = {"Trash", "IndustrialItems", "IndustrialItems", "IndustrialItems", "Trash", "IndustrialItems", "IndustrialItems", "Trash", "Electronics", "Trash"};
		/*
			Percental Item Group Spawn Chances of VehicleService:
			Restraints      = 4.35%
			RoadFlares      = 13.04%
			...
			Vehicle         = 34.78%
		*/
		VehicleService[] = {"RoadFlares", "Vehicle", "Vehicle", "Trash", "Trash", "Vehicle", "Restraints", "Trash", "IndustrialItems", "Trash", "Vehicle", "Vehicle", "IndustrialItems", "Trash", "Trash", "IndustrialItems", "RoadFlares", "Vehicle", "RoadFlares", "Vehicle", "IndustrialItems", "Vehicle", "IndustrialItems"};
		/*
			Percental Item Group Spawn Chances of Military:
			DLCGhillies       = 0.50%
			Ghillies          = 0.50%
			...
			Trash             = 49.50%
		*/
		Military[] = {"HEGrenades", "SniperAmmo", "Trash", "Trash", "MilitaryVests", "MilitaryClothing", "GuerillaClothing", "DLCAmmo", "Trash", "Trash", "CivilianItems", "Trash", "DLCVests", "Trash", "Trash", "Rifles", "Trash", "Trash", "Snipers", "MilitaryBackpacks", "Trash", "Trash", "Trash", "Snipers", "Restraints", "DLCRifles", "SniperAttachments", "UGLFlares", "Trash", "RifleAttachments", "Trash", "UGLFlares", "SmokeGrenades", "Explosives", "MedicalItems", "GuerillaHeadgear", "MilitaryClothing", "Trash", "HandGrenades", "Trash", "UGLSmokes", "Trash", "DLCVests", "Trash", "Trash", "Trash", "GuerillaBackpacks", "Trash", "MilitaryVests", "Trash", "DLCSupressor", "Trash", "CivilianItems", "SmokeGrenades", "DLCGhillies", "Trash", "GuerillaClothing", "GuerillaBackpacks", "Trash", "Trash", "MilitaryClothing", "Trash", "Trash", "Trash", "Trash", "Trash", "Trash", "DLCVests", "Trash", "GuerillaBackpacks", "Trash", "Trash", "GuerillaClothing", "Trash", "Trash", "Ghillies", "UGLSmokes", "Trash", "HandGrenades", "Trash", "Trash", "GuerillaVests", "HandGrenades", "Trash", "Trash", "LMGAmmo", "Trash", "Restraints", "UGLSmokes", "Trash", "Rebreathers", "LMG", "Trash", "DLCOptics", "Trash", "Trash", "DLCOptics", "Trash", "Trash", "UGLFlares", "Trash", "Trash", "Trash", "Trash", "RifleAttachments", "Trash", "Trash", "LMG", "SniperAttachments", "LMG", "Trash", "GuerillaClothing", "GuerillaItems", "RifleAmmo", "GuerillaClothing", "Trash", "Rifles", "Trash", "Trash", "Explosives", "Trash", "CivilianItems", "Trash", "Trash", "GuerillaItems", "DLCRifles", "Bipods", "RifleAmmo", "Trash", "MilitaryHeadgear", "Rifles", "Rifles", "Trash", "MedicalItems", "Trash", "MilitaryHeadgear", "Trash", "Trash", "HEGrenades", "GuerillaBackpacks", "Trash", "Trash", "Trash", "Trash", "GuerillaHeadgear", "MilitaryClothing", "DLCAmmo", "MilitaryBackpacks", "CivilianItems", "Trash", "Trash", "Trash", "GuerillaVests", "Trash", "Trash", "Trash", "GuerillaHeadgear", "Trash", "Trash", "Trash", "MilitaryVests", "Bipods", "Trash", "Trash", "Trash", "SniperAmmo", "GuerillaItems", "Trash", "Trash", "HEGrenades", "GuerillaVests", "MilitaryClothing", "Trash", "DLCRifles", "Trash", "Trash", "Trash", "LMG", "DLCSupressor", "RifleAttachments", "Trash", "Snipers", "GuerillaItems", "Explosives", "MilitaryHeadgear", "Explosives", "Trash", "MilitaryBackpacks", "Trash", "Trash", "Rifles", "Trash", "Trash", "Trash", "Trash", "SmokeGrenades", "Trash", "LMGAmmo", "Explosives", "RifleAmmo", "Trash", "Trash"};
		/*
			Percental Item Group Spawn Chances of Medical:
			Trash        = 30.00%
			MedicalItems = 70.00%
		*/
		Medical[] = {"MedicalItems", "Trash", "MedicalItems", "Trash", "Trash", "MedicalItems", "MedicalItems", "MedicalItems", "MedicalItems", "MedicalItems"};
		/*
			Percental Item Group Spawn Chances of Tourist:
			DLCAmmo           = 2.22%
			DLCOptics         = 2.22%
			...
			Snipers           = 17.78%
		*/
		Tourist[] = {"DLCGhillies", "Snipers", "MilitaryHeadgear", "DLCRifles", "Explosives", "DLCRifles", "Restraints", "DLCRifles", "HandGrenades", "MedicalItems", "MilitaryHeadgear", "MilitaryHeadgear", "SniperAmmo", "DLCRifles", "Restraints", "HandGrenades", "DLCRifles", "Ghillies", "CivilianItems", "Snipers", "SniperAttachments", "Snipers", "MedicalItems", "DLCAmmo", "Ghillies", "Snipers", "DLCRifles", "CivilianItems", "DLCGhillies", "MilitaryHeadgear", "MilitaryBackpacks", "Explosives", "DLCGhillies", "Snipers", "Snipers", "Snipers", "MilitaryBackpacks", "Ghillies", "DLCSupressor", "DLCOptics", "DLCRifles", "DLCRifles", "MilitaryBackpacks", "Snipers", "MilitaryBackpacks"};
		/*
			Percental Item Group Spawn Chances of Radiation:
			DLCAmmo           = 2.27%
			DLCOptics         = 2.27%
			...
			Snipers           = 11.36%
		*/
		Radiation[] = {"Explosives", "SniperAmmo", "MilitaryHeadgear", "Restraints", "MedicalItems", "DLCAmmo", "Snipers", "DLCGhillies", "MilitaryBackpacks", "DLCRifles", "MilitaryHeadgear", "DLCRifles", "SniperAttachments", "DLCRifles", "Explosives", "Ghillies", "MedicalItems", "MilitaryBackpacks", "EpicWeapons", "Restraints", "MilitaryBackpacks", "MilitaryBackpacks", "MilitaryHeadgear", "DLCRifles", "DLCSupressor", "Snipers", "MilitaryBackpacks", "Explosives", "Explosives", "Snipers", "DLCGhillies", "Snipers", "DLCGhillies", "MilitaryHeadgear", "HandGrenades", "Explosives", "MilitaryHeadgear", "DLCOptics", "DLCRifles", "EpicWeapons", "Ghillies", "HandGrenades", "Ghillies", "Snipers"};
	};
	class ItemGroups
	{
		/*
		...
		*/
		Food[] = {"Exile_Item_Raisins", "Exile_Item_Cheathas", "Exile_Item_Noodles", "Exile_Item_Noodles", "Exile_Item_GloriousKnakworst", "Exile_Item_Moobar", "Exile_Item_ChristmasTinner", "Exile_Item_Matches", "Exile_Item_Dogfood", "Exile_Item_Moobar", "Exile_Item_Dogfood", "Exile_Item_CanOpener", "Exile_Item_CockONut", "Exile_Item_CatFood", "Exile_Item_GloriousKnakworst", "Exile_Item_Cheathas", "Exile_Item_SeedAstics", "Exile_Item_SeedAstics", "Exile_Item_CanOpener", "Exile_Item_CockONut", "Exile_Item_Surstromming", "Exile_Item_Matches", "Exile_Item_InstantCoffee", "Exile_Item_Noodles", "Exile_Item_Dogfood", "Exile_Item_Dogfood", "Exile_Item_Cheathas", "Exile_Item_BBQSandwich", "Exile_Item_Raisins", "Exile_Item_EMRE", "Exile_Item_Raisins", "Exile_Item_CatFood", "Exile_Item_Dogfood", "Exile_Item_BeefParts", "Exile_Item_SeedAstics", "Exile_Item_BBQSandwich", "Exile_Item_DsNuts", "Exile_Item_DsNuts", "Exile_Item_BBQSandwich", "Exile_Item_Surstromming", "Exile_Item_Cheathas", "Exile_Item_BeefParts", "Exile_Item_CatFood", "Exile_Item_CatFood", "Exile_Item_InstantCoffee", "Exile_Item_InstantCoffee", "Exile_Item_Moobar", "Exile_Item_Matches", "Exile_Item_CatFood", "Exile_Item_Dogfood", "Exile_Item_InstantCoffee", "Exile_Item_ChristmasTinner", "Exile_Item_DsNuts", "Exile_Item_Raisins", "Exile_Item_InstantCoffee", "Exile_Item_GloriousKnakworst", "Exile_Item_InstantCoffee", "Exile_Item_SeedAstics", "Exile_Item_ChristmasTinner", "Exile_Item_Dogfood", "Exile_Item_CockONut", "Exile_Item_CockONut", "Exile_Item_Noodles", "Exile_Item_Surstromming", "Exile_Item_GloriousKnakworst", "Exile_Item_Raisins", "Exile_Item_BeefParts", "Exile_Item_Moobar", "Exile_Item_EMRE", "Exile_Item_CatFood", "Exile_Item_CanOpener", "Exile_Item_SeedAstics", "Exile_Item_Raisins", "Exile_Item_Surstromming", "Exile_Item_MacasCheese", "Exile_Item_InstantCoffee", "Exile_Item_Raisins", "Exile_Item_Moobar", "Exile_Item_MacasCheese", "Exile_Item_Matches", "Exile_Item_SeedAstics", "Exile_Item_InstantCoffee", "Exile_Item_ChristmasTinner", "Exile_Item_MacasCheese", "Exile_Item_Cheathas", "Exile_Item_BBQSandwich", "Exile_Item_Moobar", "Exile_Item_SeedAstics", "Exile_Item_SausageGravy", "Exile_Item_Cheathas", "Exile_Item_Raisins", "Exile_Item_InstantCoffee", "Exile_Item_SausageGravy", "Exile_Item_Moobar", "Exile_Item_CanOpener", "Exile_Item_Matches", "Exile_Item_BeefParts", "Exile_Item_DsNuts", "Exile_Item_CookingPot", "Exile_Item_BeefParts", "Exile_Item_GloriousKnakworst", "Exile_Item_GloriousKnakworst", "Exile_Item_InstantCoffee", "Exile_Item_DsNuts", "Exile_Item_SausageGravy", "Exile_Item_DsNuts", "Exile_Item_MacasCheese", "Exile_Item_BBQSandwich", "Exile_Item_InstantCoffee", "Exile_Item_ChristmasTinner", "Exile_Item_SausageGravy", "Exile_Item_Noodles", "Exile_Item_CatFood", "Exile_Item_CookingPot", "Exile_Item_Raisins", "Exile_Item_CockONut", "Exile_Item_Noodles", "Exile_Item_Noodles", "Exile_Item_ChristmasTinner", "Exile_Item_SausageGravy", "Exile_Item_BeefParts", "Exile_Item_BeefParts", "Exile_Item_Cheathas", "Exile_Item_BBQSandwich", "Exile_Item_DsNuts", "Exile_Item_MacasCheese", "Exile_Item_SeedAstics", "Exile_Item_CockONut", "Exile_Item_CockONut", "Exile_Item_CockONut", "Exile_Item_CanOpener", "Exile_Item_SausageGravy", "Exile_Item_SausageGravy", "Exile_Item_EMRE", "Exile_Item_Surstromming", "Exile_Item_BBQSandwich", "Exile_Item_Moobar", "Exile_Item_MacasCheese", "Exile_Item_MacasCheese", "Exile_Item_ChristmasTinner", "Exile_Item_Moobar", "Exile_Item_Surstromming", "Exile_Item_Surstromming", "Exile_Item_CookingPot"};
		/*
		...
		*/
		Drinks[] = {"Exile_Item_ChocolateMilk", "Exile_Item_ChocolateMilk", "Exile_Item_PlasticBottleDirtyWater", "Exile_Item_PlasticBottleDirtyWater", "Exile_Item_PlasticBottleDirtyWater", "Exile_Item_PlasticBottleDirtyWater", "Exile_Item_ChocolateMilk", "Exile_Item_EnergyDrink", "Exile_Item_PowerDrink", "Exile_Item_MountainDupe", "Exile_Item_PlasticBottleFreshWater", "Exile_Item_MountainDupe", "Exile_Item_Beer", "Exile_Item_PlasticBottleDirtyWater"};
		/*
		...
		*/
		Pistols[] = {"hgun_P07_khk_F", "hgun_P07_F", "hgun_ACPC2_F", "hgun_P07_F", "hgun_Rook40_F", "Exile_Weapon_Colt1911", "hgun_Pistol_Signal_F", "hgun_ACPC2_F", "Exile_Weapon_SA61", "Exile_Weapon_Makarov", "hgun_Rook40_F", "Exile_Weapon_Taurus", "hgun_Pistol_heavy_01_F", "Exile_Weapon_TaurusGold", "Exile_Weapon_SA61", "hgun_Pistol_01_F", "hgun_Pistol_heavy_02_F"};
		/*
		...
		*/
		PistolAmmo[] = {"6Rnd_45ACP_Cylinder", "Exile_Magazine_20Rnd_765x17_SA61", "Exile_Magazine_20Rnd_765x17_SA61", "9Rnd_45ACP_Mag", "Exile_Magazine_10Rnd_765x17_SA61", "Exile_Magazine_8Rnd_9x18", "Exile_Magazine_8Rnd_9x18", "30Rnd_9x21_Mag", "10Rnd_9x21_Mag", "Exile_Magazine_8Rnd_9x18", "11Rnd_45ACP_Mag", "Exile_Magazine_7Rnd_45ACP", "Exile_Magazine_10Rnd_765x17_SA61", "9Rnd_45ACP_Mag", "6Rnd_GreenSignal_F", "11Rnd_45ACP_Mag", "11Rnd_45ACP_Mag", "Exile_Magazine_6Rnd_45ACP", "Exile_Magazine_10Rnd_765x17_SA61", "9Rnd_45ACP_Mag", "30Rnd_9x21_Mag", "30Rnd_9x21_Mag", "Exile_Magazine_6Rnd_45ACP", "Exile_Magazine_7Rnd_45ACP", "30Rnd_9x21_Mag", "Exile_Magazine_6Rnd_45ACP", "6Rnd_RedSignal_F", "Exile_Magazine_10Rnd_765x17_SA61", "Exile_Magazine_7Rnd_45ACP", "6Rnd_45ACP_Cylinder", "Exile_Magazine_6Rnd_45ACP", "Exile_Magazine_20Rnd_765x17_SA61", "10Rnd_9x21_Mag", "9Rnd_45ACP_Mag", "Exile_Magazine_7Rnd_45ACP", "Exile_Magazine_20Rnd_765x17_SA61", "10Rnd_9x21_Mag", "Exile_Magazine_8Rnd_9x18", "10Rnd_9x21_Mag", "11Rnd_45ACP_Mag", "16Rnd_9x21_Mag"};
		/*
			...
			muzzle_snds_L   = 33.33%
		*/
		PistolAttachments[] = {"muzzle_snds_acp", "muzzle_snds_L", "optic_Yorris", "optic_MRD", "muzzle_snds_L", "muzzle_snds_acp"};
		/*
		...
		*/
		SMGAmmo[] = {"30Rnd_9x21_Mag_SMG_02_Tracer_Red", "30Rnd_9x21_Mag_SMG_02_Tracer_Yellow", "30Rnd_9x21_Mag_SMG_02", "30Rnd_45ACP_Mag_SMG_01_Tracer_Green", "30Rnd_45ACP_Mag_SMG_01", "30Rnd_9x21_Mag_SMG_02_Tracer_Green"};
		/*
			...
			optic_Aco                 = 16.67%
		*/
		SMGAttachments[] = {"optic_ACO_grn_smg", "optic_Aco_smg", "optic_Holosight_smg_blk_F", "optic_Holosight_smg", "optic_ACO_grn", "optic_Aco"};
		/*
		...
		*/
		Rifles[] = {"Exile_Weapon_DMR", "arifle_ARX_hex_F", "arifle_CTAR_GL_blk_F", "Exile_Weapon_AK107", "arifle_AKS_F", "arifle_AK12_F", "Exile_Weapon_LeeEnfield", "Exile_Weapon_AK74", "Exile_Weapon_LeeEnfield", "arifle_Katiba_F", "arifle_SPAR_02_blk_F", "arifle_SPAR_01_khk_F", "Exile_Weapon_CZ550", "arifle_TRG21_GL_F", "arifle_TRG20_F", "arifle_MXM_Black_F", "arifle_CTAR_ghex_F", "arifle_AK12_F", "Exile_Weapon_LeeEnfield", "arifle_SPAR_01_GL_khk_F", "arifle_SPAR_01_GL_khk_F", "Exile_Weapon_AK74_GL", "Exile_Weapon_M4", "Exile_Weapon_SVD", "Exile_Weapon_AK47", "arifle_AKM_F", "arifle_CTARS_ghex_F", "arifle_Mk20C_F", "arifle_SPAR_01_GL_snd_F", "arifle_Mk20_F", "arifle_CTAR_blk_F", "Exile_Weapon_AK47", "arifle_ARX_ghex_F", "arifle_SPAR_01_GL_blk_F", "arifle_MX_khk_F", "Exile_Weapon_LeeEnfield", "arifle_AKM_F", "arifle_MX_Black_F", "Exile_Weapon_AK107_GL", "arifle_Mk20C_F", "arifle_SPAR_03_khk_F", "arifle_AKM_FL_F", "Exile_Weapon_CZ550", "arifle_SPAR_02_snd_F", "Exile_Weapon_AK47", "arifle_MX_GL_khk_F", "Exile_Weapon_M16A2", "Exile_Weapon_CZ550", "arifle_AKS_F", "arifle_MXC_Black_F", "arifle_Mk20_F", "Exile_Weapon_LeeEnfield", "arifle_SPAR_01_blk_F", "Exile_Weapon_AKS_Gold", "arifle_SPAR_01_snd_F", "Exile_Weapon_M16A4", "Exile_Weapon_SVD", "arifle_SPAR_01_GL_blk_F", "arifle_SPAR_03_khk_F", "arifle_SPAR_02_khk_F", "arifle_MX_F", "Exile_Weapon_SVD", "arifle_TRG20_F", "Exile_Weapon_LeeEnfield", "arifle_MXC_F", "Exile_Weapon_VSSVintorez", "arifle_SDAR_F", "Exile_Weapon_M16A4", "Exile_Weapon_SVDCamo", "Exile_Weapon_M16A2", "arifle_SDAR_F", "arifle_MXC_khk_F", "arifle_CTAR_GL_blk_F", "arifle_AKM_FL_F", "arifle_TRG21_F", "arifle_SPAR_02_blk_F", "arifle_SPAR_03_blk_F", "arifle_CTARS_hex_F", "arifle_MX_khk_F", "arifle_ARX_hex_F", "Exile_Weapon_AKS_Gold", "arifle_CTAR_hex_F", "arifle_CTARS_hex_F", "arifle_TRG21_F", "arifle_MX_GL_khk_F", "arifle_MX_Black_F", "arifle_CTAR_blk_F", "arifle_CTARS_blk_F", "arifle_ARX_blk_F", "arifle_MXM_khk_F", "Exile_Weapon_LeeEnfield", "arifle_MXC_khk_F", "arifle_MXM_khk_F", "Exile_Weapon_VSSVintorez", "Exile_Weapon_LeeEnfield", "arifle_Katiba_F", "arifle_MX_GL_khk_F", "Exile_Weapon_M4", "arifle_MXM_khk_F", "arifle_AK12_F", "arifle_MX_GL_F", "Exile_Weapon_SVDCamo", "arifle_Katiba_GL_F", "arifle_SPAR_03_snd_F", "Exile_Weapon_AKS_Gold", "Exile_Weapon_VSSVintorez", "arifle_ARX_blk_F", "arifle_ARX_ghex_F", "arifle_MXC_khk_F", "arifle_AK12_GL_F", "Exile_Weapon_M16A2", "arifle_AK12_GL_F", "Exile_Weapon_M4", "Exile_Weapon_DMR", "arifle_SPAR_01_GL_snd_F", "arifle_CTAR_hex_F", "arifle_MXM_Black_F", "arifle_SPAR_01_khk_F", "arifle_MX_GL_Black_F", "arifle_SPAR_03_snd_F", "arifle_CTARS_ghex_F", "Exile_Weapon_SVDCamo", "Exile_Weapon_AK74", "arifle_Mk20_GL_F", "arifle_MXC_Black_F", "Exile_Weapon_LeeEnfield", "arifle_SPAR_01_blk_F", "arifle_SPAR_01_snd_F", "arifle_MX_F", "arifle_CTAR_ghex_F", "Exile_Weapon_M16A4", "arifle_SPAR_03_blk_F", "arifle_SPAR_02_snd_F", "arifle_MXC_F", "arifle_MXM_F", "Exile_Weapon_LeeEnfield", "Exile_Weapon_AK107", "arifle_MX_khk_F", "arifle_SPAR_02_khk_F", "arifle_CTARS_blk_F"};
		/*
		...
		*/
		RifleAmmo[] = {"Exile_Magazine_10Rnd_303", "Exile_Magazine_20Rnd_762x51_DMR_Green", "30Rnd_545x39_Mag_F", "30Rnd_545x39_Mag_F", "100Rnd_580x42_Mag_Tracer_F", "30Rnd_65x39_caseless_mag_Tracer", "100Rnd_580x42_Mag_Tracer_F", "Exile_Magazine_30Rnd_545x39_AK_Red", "Exile_Magazine_20Rnd_762x51_DMR_Red", "100Rnd_580x42_Mag_F", "Exile_Magazine_5Rnd_22LR", "Exile_Magazine_20Rnd_762x51_DMR_Yellow", "150Rnd_556x45_Drum_Mag_Tracer_F", "30Rnd_545x39_Mag_Tracer_F", "30Rnd_556x45_Stanag_green", "Exile_Magazine_30Rnd_545x39_AK_Yellow", "30Rnd_580x42_Mag_Tracer_F", "30Rnd_545x39_Mag_Green_F", "30Rnd_545x39_Mag_Tracer_F", "Exile_Magazine_10Rnd_303", "30Rnd_556x45_Stanag_Tracer_Green", "30Rnd_762x39_Mag_F", "30Rnd_545x39_Mag_Tracer_Green_F", "30Rnd_762x39_AK47_M", "30Rnd_65x39_caseless_green_mag_Tracer", "30Rnd_556x45_Stanag", "30Rnd_762x39_Mag_Green_F", "Exile_Magazine_5Rnd_22LR", "Exile_Magazine_10Rnd_9x39", "30Rnd_65x39_caseless_mag", "30Rnd_545x39_Mag_Tracer_Green_F", "30Rnd_65x39_caseless_green", "20Rnd_762x51_Mag", "100Rnd_580x42_Mag_F", "Exile_Magazine_20Rnd_9x39", "20Rnd_556x45_UW_mag", "30Rnd_556x45_Stanag_Tracer_Yellow", "150Rnd_556x45_Drum_Mag_Tracer_F", "150Rnd_556x45_Drum_Mag_F", "Exile_Magazine_10Rnd_762x54", "30Rnd_556x45_Stanag_Tracer_Red", "30Rnd_762x39_Mag_Tracer_F", "Exile_Magazine_10Rnd_303", "30Rnd_556x45_Stanag_red", "Exile_Magazine_20Rnd_762x51_DMR", "Exile_Magazine_10Rnd_762x54", "Exile_Magazine_30Rnd_762x39_AK", "30Rnd_556x45_Stanag", "30Rnd_65x39_caseless_green_mag_Tracer", "Exile_Magazine_10Rnd_9x39", "Exile_Magazine_10Rnd_303", "30Rnd_556x45_Stanag_green", "30Rnd_762x39_Mag_Tracer_Green_F", "30Rnd_762x39_Mag_Tracer_Green_F", "30Rnd_65x39_caseless_mag", "Exile_Magazine_30Rnd_545x39_AK", "30Rnd_762x39_AK47_M", "Exile_Magazine_20Rnd_9x39", "Exile_Magazine_30Rnd_545x39_AK_Red", "30Rnd_556x45_Stanag_Tracer_Red", "Exile_Magazine_30Rnd_545x39_AK_Green", "30Rnd_65x39_caseless_green", "30Rnd_556x45_Stanag_Tracer_Yellow", "Exile_Magazine_30Rnd_545x39_AK_White", "30Rnd_65x39_caseless_mag_Tracer", "Exile_Magazine_10Rnd_303", "Exile_Magazine_30Rnd_545x39_AK_White", "Exile_Magazine_30Rnd_545x39_AK_Green", "10Rnd_50BW_Mag_F", "Exile_Magazine_30Rnd_545x39_AK_Yellow", "30Rnd_580x42_Mag_F", "Exile_Magazine_10Rnd_303", "30Rnd_762x39_Mag_Tracer_F", "Exile_Magazine_30Rnd_545x39_AK", "30Rnd_556x45_Stanag_red", "30Rnd_762x39_Mag_Green_F", "150Rnd_556x45_Drum_Mag_F", "20Rnd_762x51_Mag", "Exile_Magazine_10Rnd_303", "Exile_Magazine_10Rnd_303", "Exile_Magazine_10Rnd_303", "30Rnd_556x45_Stanag_Tracer_Green", "20Rnd_556x45_UW_mag", "30Rnd_580x42_Mag_Tracer_F", "Exile_Magazine_10Rnd_303", "Exile_Magazine_20Rnd_762x51_DMR_White", "30Rnd_580x42_Mag_F", "10Rnd_50BW_Mag_F", "30Rnd_545x39_Mag_Green_F", "Exile_Magazine_30Rnd_762x39_AK", "30Rnd_762x39_Mag_F"};
		/*
			...
			optic_NVS                = 1.69%
		*/
		RifleAttachments[] = {"optic_DMS_ghex_F", "muzzle_snds_H_snd_F", "optic_Hamr", "muzzle_snds_m_khk_F", "optic_MRCO", "muzzle_snds_H_MG_blk_F", "optic_DMS", "muzzle_snds_65_TI_blk_F", "muzzle_snds_65_TI_ghex_F", "muzzle_snds_H", "acc_flashlight", "muzzle_snds_65_TI_blk_F", "optic_Holosight_blk_F", "acc_pointer_IR", "acc_pointer_IR", "muzzle_snds_H_khk_F", "muzzle_snds_m_snd_F", "optic_ERCO_blk_F", "optic_Holosight_khk_F", "optic_Holosight", "optic_ERCO_khk_F", "optic_NVS", "muzzle_snds_m_snd_F", "optic_ERCO_khk_F", "muzzle_snds_M", "muzzle_snds_58_blk_F", "muzzle_snds_65_TI_hex_F", "muzzle_snds_H_snd_F", "muzzle_snds_m_khk_F", "optic_ERCO_snd_F", "muzzle_snds_H_MG_khk_F", "optic_Holosight_blk_F", "muzzle_snds_H_MG_blk_F", "muzzle_snds_H", "optic_Hamr_khk_F", "optic_DMS_ghex_F", "muzzle_snds_58_wdm_F", "optic_Arco", "acc_flashlight", "optic_Holosight", "muzzle_snds_58_wdm_F", "optic_ERCO_blk_F", "optic_Arco_blk_F", "muzzle_snds_H_MG_khk_F", "optic_Holosight_khk_F", "muzzle_snds_M", "optic_ERCO_snd_F", "optic_Arco_ghex_F", "muzzle_snds_65_TI_ghex_F", "optic_Arco_blk_F", "optic_Arco", "optic_Arco_ghex_F", "optic_Hamr", "optic_DMS", "optic_MRCO", "muzzle_snds_65_TI_hex_F", "muzzle_snds_58_blk_F", "muzzle_snds_H_khk_F", "optic_Hamr_khk_F"};
		/*
			...
			LMG_03_F             = 12.50%
		*/
		LMG[] = {"Exile_Weapon_PKP", "LMG_03_F", "arifle_MX_SW_Black_F", "Exile_Weapon_RPK", "LMG_Zafir_F", "arifle_MX_SW_F", "Exile_Weapon_PK", "LMG_Mk200_F"};
		/*
		...
		*/
		LMGAmmo[] = {"130Rnd_338_Mag", "200Rnd_556x45_Box_F", "200Rnd_556x45_Box_Tracer_Red_F", "150Rnd_762x54_Box_Tracer", "Exile_Magazine_45Rnd_545x39_RPK_Green", "200Rnd_556x45_Box_Tracer_F", "150Rnd_762x54_Box", "100Rnd_65x39_caseless_mag_Tracer", "130Rnd_338_Mag", "150Rnd_93x64_Mag", "Exile_Magazine_75Rnd_545x39_RPK_Green", "100Rnd_65x39_caseless_mag_Tracer", "130Rnd_338_Mag", "150Rnd_93x64_Mag", "130Rnd_338_Mag", "150Rnd_93x64_Mag", "100Rnd_65x39_caseless_mag", "150Rnd_762x54_Box", "150Rnd_93x64_Mag", "150Rnd_762x54_Box", "100Rnd_65x39_caseless_mag", "130Rnd_338_Mag", "Exile_Magazine_100Rnd_762x54_PK_Green", "150Rnd_93x64_Mag", "200Rnd_556x45_Box_Red_F", "100Rnd_65x39_caseless_mag_Tracer"};
		/*
		...
		*/
		Snipers[] = {"srifle_LRR_F", "Exile_Weapon_m107", "srifle_DMR_07_blk_F", "srifle_GM6_F", "srifle_LRR_tna_F", "Exile_Weapon_ksvk", "srifle_GM6_ghex_F", "srifle_DMR_01_F", "srifle_DMR_07_ghex_F", "srifle_EBR_F", "srifle_DMR_07_hex_F"};
		/*
		...
		*/
		SniperAmmo[] = {"Exile_Magazine_10Rnd_127x99_m107_Bullet_Cam_Mag", "10Rnd_762x54_Mag", "20Rnd_650x39_Cased_Mag_F", "10Rnd_762x54_Mag", "Exile_Magazine_10Rnd_127x99_m107", "Exile_Magazine_5Rnd_127x108_KSVK", "Exile_Magazine_10Rnd_127x99_m107", "Exile_Magazine_10Rnd_127x99_m107_Bullet_Cam_Mag", "Exile_Magazine_5Rnd_127x108_APDS_KSVK", "Exile_Magazine_5Rnd_127x108_KSVK", "Exile_Magazine_5Rnd_127x108_KSVK_Bullet_Cam_Mag", "20Rnd_762x51_Mag", "Exile_Magazine_5Rnd_127x108_APDS_KSVK", "Exile_Magazine_10Rnd_338_Bullet_Cam_Mag", "Exile_Magazine_10Rnd_93x64_DMR_05_Bullet_Cam_Mag", "5Rnd_127x108_APDS_Mag", "10Rnd_762x54_Mag", "Exile_Magazine_5Rnd_127x108_APDS_KSVK", "Exile_Magazine_5Rnd_127x108_Bullet_Cam_Mag", "Exile_Magazine_10Rnd_127x99_m107_Bullet_Cam_Mag", "20Rnd_650x39_Cased_Mag_F", "5Rnd_127x108_Mag", "5Rnd_127x108_Mag", "Exile_Magazine_10Rnd_127x99_m107", "20Rnd_762x51_Mag", "20Rnd_762x51_Mag", "Exile_Magazine_7Rnd_408_Bullet_Cam_Mag", "10Rnd_762x54_Mag", "10Rnd_762x54_Mag", "Exile_Magazine_10Rnd_338_Bullet_Cam_Mag", "10Rnd_762x54_Mag", "Exile_Magazine_7Rnd_408_Bullet_Cam_Mag", "10Rnd_762x54_Mag", "Exile_Magazine_5Rnd_127x108_APDS_KSVK", "Exile_Magazine_5Rnd_127x108_KSVK", "20Rnd_650x39_Cased_Mag_F", "5Rnd_127x108_APDS_Mag", "20Rnd_650x39_Cased_Mag_F", "20Rnd_762x51_Mag", "Exile_Magazine_10Rnd_338_Bullet_Cam_Mag", "20Rnd_762x51_Mag", "Exile_Magazine_10Rnd_127x99_m107", "Exile_Magazine_7Rnd_408_Bullet_Cam_Mag", "Exile_Magazine_5Rnd_127x108_KSVK", "7Rnd_408_Mag", "7Rnd_408_Mag", "7Rnd_408_Mag", "5Rnd_127x108_APDS_Mag", "Exile_Magazine_10Rnd_338_Bullet_Cam_Mag", "20Rnd_762x51_Mag", "Exile_Magazine_5Rnd_127x108_KSVK", "Exile_Magazine_10Rnd_93x64_DMR_05_Bullet_Cam_Mag", "Exile_Magazine_5Rnd_127x108_KSVK", "Exile_Magazine_5Rnd_127x108_APDS_KSVK", "Exile_Magazine_10Rnd_93x64_DMR_05_Bullet_Cam_Mag", "Exile_Magazine_10Rnd_127x99_m107", "5Rnd_127x108_APDS_Mag", "5Rnd_127x108_Mag", "Exile_Magazine_5Rnd_127x108_APDS_KSVK", "Exile_Magazine_10Rnd_338_Bullet_Cam_Mag", "Exile_Magazine_10Rnd_127x99_m107", "20Rnd_650x39_Cased_Mag_F", "Exile_Magazine_5Rnd_127x108_APDS_KSVK", "Exile_Magazine_5Rnd_127x108_KSVK", "20Rnd_650x39_Cased_Mag_F", "Exile_Magazine_5Rnd_127x108_APDS_KSVK_Bullet_Cam_Mag", "20Rnd_762x51_Mag", "Exile_Magazine_10Rnd_127x99_m107", "20Rnd_650x39_Cased_Mag_F", "20Rnd_762x51_Mag", "20Rnd_650x39_Cased_Mag_F", "5Rnd_127x108_Mag", "7Rnd_408_Mag", "10Rnd_762x54_Mag", "Exile_Magazine_5Rnd_127x108_KSVK", "20Rnd_762x51_Mag", "5Rnd_127x108_APDS_Mag", "10Rnd_762x54_Mag", "20Rnd_650x39_Cased_Mag_F", "10Rnd_762x54_Mag", "20Rnd_650x39_Cased_Mag_F", "10Rnd_762x54_Mag", "Exile_Magazine_5Rnd_127x108_Bullet_Cam_Mag", "20Rnd_650x39_Cased_Mag_F", "20Rnd_650x39_Cased_Mag_F", "20Rnd_650x39_Cased_Mag_F", "5Rnd_127x108_APDS_Mag", "20Rnd_762x51_Mag", "5Rnd_127x108_Mag", "20Rnd_762x51_Mag", "Exile_Magazine_10Rnd_93x64_DMR_05_Bullet_Cam_Mag", "Exile_Magazine_10Rnd_127x99_m107", "5Rnd_127x108_Mag", "Exile_Magazine_5Rnd_127x108_KSVK", "Exile_Magazine_5Rnd_127x108_APDS_Bullet_Cam_Mag", "20Rnd_650x39_Cased_Mag_F", "Exile_Magazine_5Rnd_127x108_KSVK_Bullet_Cam_Mag", "Exile_Magazine_5Rnd_127x108_KSVK", "7Rnd_408_Mag", "7Rnd_408_Mag", "5Rnd_127x108_APDS_Mag", "20Rnd_762x51_Mag", "20Rnd_762x51_Mag", "5Rnd_127x108_Mag", "20Rnd_650x39_Cased_Mag_F", "20Rnd_762x51_Mag", "7Rnd_408_Mag", "7Rnd_408_Mag", "20Rnd_762x51_Mag", "10Rnd_762x54_Mag", "20Rnd_762x51_Mag", "10Rnd_762x54_Mag", "20Rnd_650x39_Cased_Mag_F", "20Rnd_762x51_Mag", "20Rnd_650x39_Cased_Mag_F", "20Rnd_762x51_Mag", "Exile_Magazine_10Rnd_127x99_m107", "20Rnd_650x39_Cased_Mag_F", "10Rnd_762x54_Mag", "Exile_Magazine_10Rnd_127x99_m107", "10Rnd_762x54_Mag", "Exile_Magazine_10Rnd_93x64_DMR_05_Bullet_Cam_Mag", "10Rnd_762x54_Mag", "7Rnd_408_Mag", "20Rnd_650x39_Cased_Mag_F", "20Rnd_762x51_Mag", "7Rnd_408_Mag", "10Rnd_762x54_Mag", "5Rnd_127x108_Mag", "Exile_Magazine_5Rnd_127x108_APDS_KSVK", "5Rnd_127x108_Mag", "5Rnd_127x108_Mag", "20Rnd_650x39_Cased_Mag_F", "5Rnd_127x108_APDS_Mag", "20Rnd_650x39_Cased_Mag_F"};
		/*
			...
			optic_DMS           = 11.11%
		*/
		SniperAttachments[] = {"muzzle_snds_B", "optic_SOS", "muzzle_snds_B_snd_F", "optic_LRPS_tna_F", "optic_SOS_khk_F", "muzzle_snds_B_khk_F", "optic_LRPS", "optic_DMS", "optic_LRPS_ghex_F"};
		/*
		...
		*/
		DLCRifles[] = {"srifle_DMR_02_sniper_F", "srifle_DMR_04_F", "srifle_DMR_05_blk_F", "srifle_DMR_02_F", "srifle_DMR_04_F", "srifle_DMR_03_F", "srifle_DMR_04_Tan_F", "srifle_DMR_06_camo_F", "srifle_DMR_05_hex_F", "srifle_DMR_03_khaki_F", "srifle_DMR_03_tan_F", "srifle_DMR_05_hex_F", "srifle_DMR_02_sniper_F", "srifle_DMR_03_woodland_F", "srifle_DMR_03_F", "srifle_DMR_05_hex_F", "srifle_DMR_02_camo_F", "srifle_DMR_04_F", "srifle_DMR_05_tan_F", "srifle_DMR_04_Tan_F", "srifle_DMR_05_blk_F", "srifle_DMR_05_tan_F", "srifle_DMR_05_tan_F", "srifle_DMR_04_Tan_F", "srifle_DMR_02_F", "srifle_DMR_04_Tan_F", "srifle_DMR_02_F", "srifle_DMR_05_blk_F", "srifle_DMR_04_Tan_F", "srifle_DMR_02_F", "srifle_DMR_02_sniper_F", "srifle_DMR_04_Tan_F", "srifle_DMR_02_camo_F", "srifle_DMR_06_olive_F", "srifle_DMR_05_hex_F", "srifle_DMR_03_woodland_F", "srifle_DMR_02_camo_F", "srifle_DMR_05_blk_F", "srifle_DMR_02_sniper_F", "srifle_DMR_02_camo_F", "srifle_DMR_03_khaki_F", "srifle_DMR_06_olive_F", "srifle_DMR_04_F", "srifle_DMR_05_tan_F", "srifle_DMR_06_camo_F", "srifle_DMR_04_F", "srifle_DMR_02_F", "srifle_DMR_05_blk_F", "srifle_DMR_05_hex_F", "srifle_DMR_06_camo_F", "srifle_DMR_05_blk_F", "srifle_DMR_05_hex_F", "srifle_DMR_05_tan_F", "srifle_DMR_03_F", "srifle_DMR_06_olive_F", "srifle_DMR_04_F", "srifle_DMR_02_camo_F", "srifle_DMR_03_tan_F", "srifle_DMR_04_F", "srifle_DMR_05_tan_F", "srifle_DMR_02_sniper_F", "srifle_DMR_05_tan_F", "srifle_DMR_05_hex_F", "srifle_DMR_05_blk_F", "srifle_DMR_03_woodland_F", "srifle_DMR_03_khaki_F", "srifle_DMR_02_F", "srifle_DMR_02_camo_F", "srifle_DMR_05_blk_F", "srifle_DMR_05_hex_F", "srifle_DMR_04_Tan_F", "srifle_DMR_05_tan_F", "srifle_DMR_03_tan_F", "srifle_DMR_02_sniper_F"};
		/*
		...
		*/
		DLCAmmo[] = {"10Rnd_93x64_DMR_05_Mag", "10Rnd_93x64_DMR_05_Mag", "10Rnd_127x54_Mag", "10Rnd_127x54_Mag", "10Rnd_338_Mag", "10Rnd_338_Mag", "20Rnd_762x51_Mag", "20Rnd_762x51_Mag", "10Rnd_338_Mag", "10Rnd_93x64_DMR_05_Mag"};
		/*
			...
			optic_KHS_tan = 14.29%
		*/
		DLCOptics[] = {"optic_KHS_hex", "optic_KHS_blk", "optic_AMS_khk", "optic_AMS", "optic_AMS_snd", "optic_KHS_tan", "optic_KHS_old"};
		/*
			...
			muzzle_snds_B         = 16.67%
		*/
		DLCSupressor[] = {"muzzle_snds_338_green", "muzzle_snds_338_sand", "muzzle_snds_338_black", "muzzle_snds_93mmg", "muzzle_snds_93mmg_tan", "muzzle_snds_B"};
		/*
			Percental Item Spawn Chances of EpicWeapons:
			MMG_01_hex_F   = 20.00%
			MMG_01_tan_F   = 20.00%
		...
		*/
		...
		/*
			...
			bipod_01_F_khk = 11.11%
		*/
		Bipods[] = {"bipod_03_F_oli", "bipod_02_F_blk", "bipod_01_F_khk", "bipod_02_F_hex", "bipod_03_F_blk", "bipod_02_F_tan", "bipod_01_F_mtp", "bipod_01_F_blk", "bipod_01_F_snd"};
		/*
		...
		*/
		UGLFlares[] = {"UGL_FlareYellow_F", "UGL_FlareRed_F", "3Rnd_UGL_FlareYellow_F", "UGL_FlareGreen_F", "UGL_FlareYellow_F", "3Rnd_UGL_FlareWhite_F", "UGL_FlareGreen_F", "UGL_FlareWhite_F", "UGL_FlareGreen_F", "UGL_FlareRed_F", "3Rnd_UGL_FlareGreen_F", "UGL_FlareWhite_F", "UGL_FlareYellow_F", "3Rnd_UGL_FlareRed_F", "UGL_FlareWhite_F", "UGL_FlareRed_F"};
		/*
		...
		*/
		UGLSmokes[] = {"3Rnd_SmokeGreen_Grenade_shell", "1Rnd_Smoke_Grenade_shell", "1Rnd_SmokeBlue_Grenade_shell", "1Rnd_SmokeYellow_Grenade_shell", "1Rnd_Smoke_Grenade_shell", "1Rnd_SmokePurple_Grenade_shell", "1Rnd_SmokeBlue_Grenade_shell", "3Rnd_SmokeBlue_Grenade_shell", "3Rnd_SmokeRed_Grenade_shell", "1Rnd_SmokeGreen_Grenade_shell", "1Rnd_SmokeRed_Grenade_shell", "1Rnd_SmokeOrange_Grenade_shell", "1Rnd_SmokeYellow_Grenade_shell", "1Rnd_SmokeRed_Grenade_shell", "3Rnd_SmokeOrange_Grenade_shell", "1Rnd_SmokeGreen_Grenade_shell", "1Rnd_SmokeGreen_Grenade_shell", "1Rnd_SmokePurple_Grenade_shell", "1Rnd_SmokeOrange_Grenade_shell", "1Rnd_SmokeOrange_Grenade_shell", "3Rnd_SmokeYellow_Grenade_shell", "3Rnd_Smoke_Grenade_shell", "1Rnd_SmokeBlue_Grenade_shell", "1Rnd_SmokePurple_Grenade_shell", "1Rnd_Smoke_Grenade_shell", "1Rnd_SmokeRed_Grenade_shell", "1Rnd_SmokeYellow_Grenade_shell", "3Rnd_SmokePurple_Grenade_shell"};
		/*
		...
		*/
		Explosives[] = {"IEDUrbanSmall_Remote_Mag", "IEDLandSmall_Remote_Mag", "APERSMine_Range_Mag", "IEDUrbanSmall_Remote_Mag", "APERSBoundingMine_Range_Mag", "APERSBoundingMine_Range_Mag", "APERSBoundingMine_Range_Mag", "DemoCharge_Remote_Mag", "APERSMine_Range_Mag", "IEDLandSmall_Remote_Mag", "APERSTripMine_Wire_Mag", "DemoCharge_Remote_Mag", "APERSTripMine_Wire_Mag", "IEDLandSmall_Remote_Mag", "SatchelCharge_Remote_Mag", "IEDUrbanSmall_Remote_Mag", "DemoCharge_Remote_Mag", "APERSMine_Range_Mag", "APERSTripMine_Wire_Mag"};
		/*
		...
		*/
		CivilianItems[] = {"ItemMap", "ItemWatch", "Binocular", "Exile_Item_Heatpack", "Exile_Item_Heatpack", "ItemMap", "Exile_Item_Heatpack", "ItemWatch", "Exile_Item_Heatpack", "Exile_Item_Heatpack", "Exile_Item_MobilePhone", "ItemGPS", "ItemRadio", "ItemWatch", "ItemRadio", "ItemMap", "ItemMap", "ItemWatch", "Exile_Item_Heatpack", "ItemMap", "ItemGPS", "Exile_Item_Heatpack", "Exile_Item_Heatpack", "ItemMap", "ItemWatch", "Binocular", "ItemRadio", "Binocular", "ItemMap", "ItemGPS", "ItemWatch", "ItemRadio", "ItemRadio", "ItemGPS", "ItemRadio", "Binocular"};
		/*
			...
			U_Rangemaster            = 5.26%
		*/
		CivilianClothing[] = {"U_C_HunterBody_grn", "U_Rangemaster", "U_I_C_Soldier_Bandit_5_F", "U_C_Poor_2", "U_C_Poloshirt_tricolour", "U_C_Man_casual_4_F", "U_C_Poor_shorts_1", "U_C_Poloshirt_stripped", "U_C_man_sport_3_F", "U_C_Poloshirt_blue", "U_C_Poor_2", "U_C_Poloshirt_burgundy", "U_C_Man_casual_6_F", "U_C_Man_casual_6_F", "U_C_Poor_1", "U_C_Journalist", "U_C_Poor_1", "U_C_Poor_shorts_1", "U_C_Man_casual_1_F", "U_C_Poor_1", "U_C_Poor_shorts_1", "U_C_Poloshirt_stripped", "U_C_Poloshirt_salmon", "U_C_Poor_shorts_1", "U_C_Poloshirt_stripped", "U_I_C_Soldier_Bandit_1_F", "U_Rangemaster", "U_C_Poloshirt_tricolour", "U_C_Poor_2", "U_C_Poor_2", "U_I_C_Soldier_Bandit_4_F", "U_C_HunterBody_grn", "U_I_C_Soldier_Bandit_1_F", "U_C_Poloshirt_burgundy", "U_C_Man_casual_6_F", "U_NikosAgedBody", "U_C_Scientist", "U_C_Poloshirt_blue", "U_C_Poor_2", "U_I_C_Soldier_Bandit_3_F", "U_C_Man_casual_4_F", "U_C_Poor_1", "U_C_Man_casual_6_F", "U_C_Poor_1", "U_Rangemaster", "U_C_man_sport_2_F", "U_C_man_sport_1_F", "U_C_Man_casual_6_F", "U_C_Poloshirt_salmon", "U_I_C_Soldier_Bandit_2_F", "U_C_man_sport_2_F", "U_C_Poor_2", "U_C_Journalist", "U_C_Man_casual_5_F", "U_C_Poloshirt_salmon", "U_C_Poloshirt_burgundy", "U_C_Man_casual_2_F", "U_C_Man_casual_4_F", "U_C_Poloshirt_tricolour", "U_I_C_Soldier_Bandit_2_F", "U_C_man_sport_2_F", "U_C_HunterBody_grn", "U_C_Poloshirt_blue", "U_C_HunterBody_grn", "U_C_Poloshirt_tricolour", "U_C_man_sport_3_F", "U_C_Poor_1", "U_C_Poloshirt_blue", "U_I_C_Soldier_Bandit_3_F", "U_C_Journalist", "U_C_Man_casual_5_F", "U_C_Man_casual_3_F", "U_C_Poloshirt_stripped", "U_I_C_Soldier_Bandit_1_F", "U_C_Journalist", "U_C_Man_casual_2_F", "U_C_Poloshirt_blue", "U_I_C_Soldier_Bandit_2_F", "U_C_Poloshirt_stripped", "U_I_C_Soldier_Bandit_3_F", "U_C_Poloshirt_tricolour", "U_C_Man_casual_1_F", "U_C_Journalist", "U_C_Poloshirt_salmon", "U_C_man_sport_2_F", "U_C_Poloshirt_salmon", "U_C_Poloshirt_salmon", "U_C_Poloshirt_stripped", "U_I_C_Soldier_Bandit_5_F", "U_C_Poor_shorts_1", "U_C_man_sport_1_F", "U_C_Man_casual_4_F", "U_C_Poor_2", "U_C_Man_casual_5_F", "U_I_C_Soldier_Bandit_5_F", "U_C_Scientist", "U_Rangemaster", "U_C_Poloshirt_stripped", "U_C_HunterBody_grn", "U_C_Man_casual_2_F", "U_I_C_Soldier_Bandit_5_F", "U_C_man_sport_1_F", "U_C_Poloshirt_blue", "U_C_Poloshirt_blue", "U_C_Scientist", "U_C_Scientist", "U_C_Scientist", "U_Rangemaster", "U_I_C_Soldier_Bandit_3_F", "U_I_C_Soldier_Bandit_2_F", "U_Rangemaster", "U_I_C_Soldier_Bandit_4_F", "U_I_C_Soldier_Bandit_4_F", "U_C_Man_casual_2_F", "U_C_Man_casual_4_F", "U_C_Poor_shorts_1", "U_C_Journalist", "U_C_Poloshirt_burgundy", "U_C_man_sport_1_F", "U_C_Poor_shorts_1", "U_C_Poloshirt_salmon", "U_C_Man_casual_5_F", "U_C_HunterBody_grn", "U_C_Poloshirt_burgundy", "U_C_Poor_1", "U_C_Man_casual_3_F", "U_Rangemaster", "U_C_Man_casual_1_F", "U_C_Man_casual_3_F", "U_C_Scientist", "U_C_Poloshirt_burgundy", "U_NikosBody", "U_C_man_sport_2_F", "U_C_Scientist", "U_C_Journalist", "U_C_HunterBody_grn", "U_I_C_Soldier_Bandit_5_F", "U_C_Scientist", "U_C_Man_casual_3_F", "U_C_Poloshirt_tricolour", "U_I_C_Soldier_Bandit_3_F", "U_C_Journalist", "U_C_Poor_shorts_1", "U_C_Poloshirt_tricolour", "U_C_Poor_shorts_1", "U_I_C_Soldier_Bandit_4_F", "U_C_man_sport_3_F", "U_C_Poor_2", "U_I_C_Soldier_Bandit_1_F", "U_C_Poor_1", "U_C_Man_casual_3_F", "U_C_man_sport_3_F", "U_C_HunterBody_grn", "U_C_Journalist", "U_C_HunterBody_grn", "U_Rangemaster", "U_C_Man_casual_5_F", "U_C_man_sport_3_F", "U_C_Man_casual_2_F", "U_Rangemaster", "U_C_Man_casual_1_F", "U_C_Poor_1", "U_I_C_Soldier_Bandit_2_F", "U_C_Poor_2", "U_C_man_sport_1_F", "U_I_C_Soldier_Bandit_4_F", "U_C_Man_casual_1_F", "U_C_Scientist", "U_OrestesBody", "U_C_Poloshirt_burgundy", "U_I_C_Soldier_Bandit_1_F"};
		/*
		...
		*/
		CivilianBackpacks[] = {"B_AssaultPack_cbr", "B_OutdoorPack_blk", "B_AssaultPack_tna_F", "B_OutdoorPack_tan", "B_AssaultPack_blk", "B_AssaultPack_dgtl", "B_Kitbag_mcamo", "B_Kitbag_sgg", "B_Kitbag_cbr", "B_AssaultPack_sgg", "B_AssaultPack_rgr", "B_OutdoorPack_blu", "B_HuntingBackpack", "B_AssaultPack_khk", "B_AssaultPack_mcamo"};
		/*
		...
		*/
		CivilianHeadgear[] = {"H_Beret_blk_POLICE", "H_Cap_oli", "H_Bandanna_surfer", "H_Cap_blk_Raven", "H_StrawHat_dark", "H_Hat_brown", "H_Cap_tan", "H_Cap_headphones", "H_Hat_checker", "H_Cap_blu", "H_Cap_red", "H_Hat_blue", "H_Cap_grn", "H_Cap_press", "H_Cap_blk", "H_StrawHat", "H_Hat_grey", "H_Hat_tan"};
		/*
		...
		*/
		GuerillaItems[] = {"O_NVGoggles_ghex_F", "Rangefinder", "O_NVGoggles_urb_F", "ItemCompass", "ItemCompass", "ItemCompass", "ItemCompass", "ItemCompass", "ItemCompass", "ItemCompass", "NVGoggles_tna_F", "NVGoggles", "ItemCompass", "ItemCompass", "O_NVGoggles_hex_F", "ItemCompass"};
		/*
		...
		*/
		GuerillaClothing[] = {"U_IG_Guerilla2_3", "U_IG_Guerilla3_1", "U_IG_Guerilla3_1", "U_I_C_Soldier_Para_4_F", "U_IG_Guerilla3_1", "U_IG_leader", "U_IG_Guerilla2_3", "U_IG_Guerilla2_1", "U_IG_Guerilla2_1", "U_I_C_Soldier_Para_3_F", "U_IG_Guerilla2_2", "U_IG_Guerilla2_1", "U_IG_Guerilla2_3", "U_I_C_Soldier_Para_5_F", "U_I_C_Soldier_Para_5_F", "U_IG_Guerilla3_2", "U_IG_Guerilla1_1", "U_IG_leader", "U_IG_Guerilla2_2", "U_IG_Guerilla3_1", "U_I_C_Soldier_Camo_F", "U_IG_Guerilla2_2", "U_I_C_Soldier_Para_3_F", "U_I_C_Soldier_Para_2_F", "U_I_C_Soldier_Para_1_F", "U_I_G_resistanceLeader_F", "U_IG_Guerilla3_2", "U_I_C_Soldier_Camo_F", "U_IG_Guerilla1_1", "U_IG_Guerilla3_2", "U_IG_leader", "U_IG_Guerilla3_2", "U_IG_Guerilla2_1", "U_IG_Guerilla3_2", "U_I_C_Soldier_Para_4_F", "U_I_C_Soldier_Para_2_F", "U_IG_Guerilla2_2", "U_IG_Guerilla1_1", "U_IG_Guerilla1_1", "U_I_C_Soldier_Para_3_F", "U_IG_Guerilla2_3", "U_IG_Guerilla2_3", "U_I_C_Soldier_Para_4_F", "U_IG_Guerilla1_1", "U_I_C_Soldier_Para_2_F", "U_IG_Guerilla2_2", "U_I_C_Soldier_Para_5_F", "U_I_C_Soldier_Para_1_F", "U_IG_Guerilla2_2", "U_IG_Guerilla2_3", "U_IG_Guerilla2_1", "U_I_C_Soldier_Camo_F", "U_IG_Guerilla1_1", "U_IG_Guerilla3_1", "U_IG_leader", "U_IG_Guerilla2_1", "U_I_C_Soldier_Para_1_F"};
		/*
		...
		*/
		GuerillaBackpacks[] = {"B_ViperLightHarness_base_F", "B_FieldPack_cbr", "B_FieldPack_ocamo", "B_ViperLightHarness_oli_F", "B_FieldPack_cbr", "B_Bergen_mcamo", "B_FieldPack_cbr", "B_FieldPack_blk", "B_ViperLightHarness_blk_F", "B_ViperLightHarness_ghex_F", "B_FieldPack_cbr", "B_ViperLightHarness_blk_F", "B_ViperHarness_ghex_F", "B_FieldPack_oucamo", "B_ViperHarness_base_F", "B_ViperLightHarness_hex_F", "B_FieldPack_ocamo", "B_ViperLightHarness_blk_F", "B_FieldPack_blk", "B_ViperHarness_khk_F", "B_ViperLightHarness_base_F", "B_FieldPack_ocamo", "B_FieldPack_oucamo", "B_FieldPack_ocamo", "B_ViperHarness_khk_F", "B_ViperHarness_oli_F", "B_Bergen_sgg", "B_ViperLightHarness_khk_F", "B_Bergen_blk", "B_FieldPack_blk", "B_FieldPack_ghex_F", "B_ViperLightHarness_khk_F", "B_ViperHarness_hex_F", "B_ViperHarness_base_F", "B_FieldPack_oucamo", "B_ViperHarness_blk_F", "B_FieldPack_ocamo", "B_ViperLightHarness_khk_F", "B_ViperLightHarness_oli_F", "B_ViperLightHarness_hex_F", "B_FieldPack_oucamo", "B_ViperHarness_blk_F", "B_ViperHarness_hex_F", "B_FieldPack_blk", "B_ViperLightHarness_oli_F", "B_ViperLightHarness_base_F", "B_FieldPack_oucamo", "B_FieldPack_cbr", "B_ViperLightHarness_hex_F", "B_ViperHarness_ghex_F", "B_ViperLightHarness_ghex_F", "B_FieldPack_blk", "B_Bergen_rgr", "B_ViperLightHarness_ghex_F", "B_ViperHarness_oli_F"};
		/*
		...
		*/
		GuerillaVests[] = {"V_Chestrig_oli", "V_BandollierB_rgr", "V_Chestrig_blk", "V_HarnessO_brn", "V_HarnessOSpec_brn", "V_HarnessOGL_gry", "V_BandollierB_oli", "V_HarnessO_gry", "V_BandollierB_cbr", "V_BandollierB_khk", "V_BandollierB_rgr", "V_HarnessOGL_brn", "V_I_G_resistanceLeader_F", "V_BandollierB_blk", "V_HarnessO_gry", "V_Chestrig_blk", "V_HarnessOGL_brn", "V_Chestrig_rgr", "V_Chestrig_khk", "V_BandollierB_khk", "V_HarnessOGL_gry", "V_HarnessO_brn", "V_Chestrig_rgr", "V_BandollierB_oli", "V_BandollierB_cbr", "V_Chestrig_khk", "V_Chestrig_oli", "V_HarnessOSpec_brn", "V_HarnessOSpec_gry", "V_BandollierB_blk", "V_HarnessOSpec_gry"};
		/*
		...
		*/
		GuerillaHeadgear[] = {"H_Booniehat_khk_hs", "H_ShemagOpen_tan", "H_Bandanna_cbr", "H_Bandanna_cbr", "H_Booniehat_grn", "H_Shemag_tan", "H_Bandanna_cbr", "H_Bandanna_khk", "H_Booniehat_mcamo", "H_Shemag_olive_hs", "H_Beret_grn", "H_Booniehat_tan", "H_Bandanna_gry", "H_Cap_khaki_specops_UK", "H_Watchcap_khk", "H_Booniehat_khk_hs", "H_Booniehat_indp", "H_MilCap_ghex_F", "H_Beret_ocamo", "H_Booniehat_khk", "H_Bandanna_khk_hs", "H_TurbanO_blk", "H_Booniehat_khk", "Exile_Headgear_GasMask", "H_ShemagOpen_khk", "H_Booniehat_dirty", "H_Booniehat_dgtl", "H_Bandanna_sgg", "H_Shemag_olive", "H_Shemag_tan", "Exile_Headgear_GasMask", "H_Bandanna_camo", "H_Booniehat_indp", "H_Watchcap_sgg", "H_Bandanna_khk", "H_BandMask_blk", "H_Bandanna_mcamo", "H_Booniehat_indp", "H_Beret_Colonel", "H_Cap_khaki_specops_UK", "H_Beret_grn_SF", "H_Bandanna_gry", "H_Watchcap_blk", "H_Watchcap_blk", "H_ShemagOpen_tan", "H_Bandanna_camo", "H_MilCap_gen_F", "Exile_Headgear_GasMask", "H_Booniehat_grn", "H_Cap_tan_specops_US", "H_Booniehat_tan", "H_MilCap_ghex_F", "H_MilCap_tna_F", "H_Booniehat_indp", "H_Booniehat_khk_hs", "H_Booniehat_dirty", "H_Booniehat_dgtl", "H_Booniehat_tan", "H_Booniehat_tan", "H_Cap_oli_Syndikat_F", "H_Cap_tan_specops_US", "H_Beret_red", "H_Booniehat_tna_F", "H_Bandanna_khk", "H_Bandanna_mcamo", "H_Cap_oli_Syndikat_F", "H_ShemagOpen_khk", "H_Booniehat_tna_F", "H_Bandanna_mcamo", "H_Shemag_khk", "H_Bandanna_gry", "H_Hat_camo", "H_Cap_khaki_specops_UK", "H_Watchcap_khk", "H_Booniehat_mcamo", "H_Cap_brn_SPECOPS", "H_Booniehat_mcamo", "H_Booniehat_khk_hs", "H_Booniehat_mcamo", "H_Beret_blk", "H_MilCap_tna_F", "H_Cap_blk_Syndikat_F", "H_Booniehat_dgtl", "H_Cap_blk_Syndikat_F", "H_Bandanna_khk_hs", "H_Watchcap_khk", "H_Booniehat_grn", "H_Shemag_olive_hs", "H_Hat_camo", "H_FakeHeadgear_Syndikat_F", "H_Bandanna_khk_hs", "H_Cap_grn_Syndikat_F", "H_Booniehat_grn", "H_Watchcap_blk", "Exile_Headgear_GasMask", "H_Bandanna_sgg", "H_Watchcap_sgg", "H_Cap_tan_Syndikat_F", "H_TurbanO_blk", "H_BandMask_blk", "H_Beret_02", "H_Hat_camo", "H_Shemag_olive", "H_FakeHeadgear_Syndikat_F", "H_Cap_tan_specops_US", "H_Shemag_khk", "H_Bandanna_camo", "H_Watchcap_camo", "H_Booniehat_dirty", "H_Cap_brn_SPECOPS", "H_Booniehat_khk", "H_Booniehat_dirty", "H_MilCap_gen_F", "H_Cap_grn_Syndikat_F", "H_Cap_tan_Syndikat_F", "H_BandMask_blk", "H_Booniehat_dgtl", "H_Cap_brn_SPECOPS", "H_Beret_brn_SF", "H_Watchcap_camo", "H_Booniehat_khk", "H_Bandanna_sgg"};
		/*
		...
		*/
		MilitaryClothing[] = {"U_O_PilotCoveralls", "U_O_T_Soldier_F", "U_B_PilotCoveralls", "U_B_CTRG_Soldier_urb_2_F", "U_B_CTRG_Soldier_urb_3_F", "U_B_CombatUniform_mcam", "U_B_T_Soldier_AR_F", "U_O_T_Soldier_F", "U_I_CombatUniform", "U_B_CTRG_Soldier_urb_3_F", "U_B_CTRG_Soldier_urb_1_F", "U_B_CTRG_2", "U_I_pilotCoveralls", "U_O_V_Soldier_Viper_F", "U_B_CombatUniform_mcam_vest", "U_I_HeliPilotCoveralls", "U_B_T_Soldier_SL_F", "U_B_CombatUniform_mcam_tshirt", "U_B_CTRG_Soldier_2_F", "U_I_CombatUniform", "U_B_HeliPilotCoveralls", "U_B_CombatUniform_mcam_vest", "U_B_CombatUniform_mcam_worn", "U_B_T_Soldier_SL_F", "U_B_GEN_Soldier_F", "U_I_pilotCoveralls", "U_B_CTRG_Soldier_2_F", "U_B_PilotCoveralls", "U_B_GEN_Commander_F", "U_O_CombatUniform_ocamo", "U_B_CTRG_1", "U_B_CTRG_3", "U_I_Wetsuit", "U_O_SpecopsUniform_blk", "U_O_PilotCoveralls", "U_I_OfficerUniform", "U_B_SpecopsUniform_sgg", "U_O_T_Soldier_F", "U_B_CTRG_Soldier_2_F", "U_B_CTRG_Soldier_urb_1_F", "U_B_CTRG_1", "U_O_OfficerUniform_ocamo", "U_B_CombatUniform_mcam_vest", "U_B_CTRG_3", "U_O_PilotCoveralls", "U_B_PilotCoveralls", "U_I_pilotCoveralls", "U_B_CTRG_1", "U_B_CTRG_Soldier_3_F", "U_I_Wetsuit", "U_B_CTRG_Soldier_3_F", "U_B_CTRG_1", "U_B_CombatUniform_mcam_worn", "U_B_T_Soldier_AR_F", "U_B_T_Soldier_AR_F", "U_B_GEN_Soldier_F", "U_B_CTRG_Soldier_urb_2_F", "U_B_CombatUniform_mcam_tshirt", "U_B_CTRG_Soldier_urb_2_F", "U_I_OfficerUniform", "U_B_CTRG_Soldier_F", "U_B_T_Soldier_SL_F", "U_B_CTRG_Soldier_urb_2_F", "U_O_T_Soldier_F", "U_B_CTRG_Soldier_urb_2_F", "U_O_CombatUniform_oucamo", "U_B_HeliPilotCoveralls", "U_B_GEN_Commander_F", "U_B_GEN_Soldier_F", "U_O_OfficerUniform_ocamo", "U_B_T_Soldier_SL_F", "U_O_V_Soldier_Viper_hex_F", "U_B_CTRG_Soldier_3_F", "U_B_CTRG_Soldier_F", "U_B_CombatUniform_mcam_tshirt", "U_I_CombatUniform_shortsleeve", "U_O_V_Soldier_Viper_F", "U_B_CombatUniform_mcam", "U_O_T_Officer_F", "U_O_T_Officer_F", "U_B_CTRG_2", "U_B_CombatUniform_mcam_worn", "U_B_CTRG_Soldier_F", "U_B_CTRG_2", "U_B_CTRG_Soldier_3_F", "U_B_CombatUniform_mcam_worn", "U_I_CombatUniform_tshirt", "U_I_HeliPilotCoveralls", "U_O_T_Officer_F", "U_B_CTRG_3", "U_B_T_Soldier_SL_F", "U_I_CombatUniform_tshirt", "U_B_CombatUniform_mcam_tshirt", "U_B_GEN_Commander_F", "U_B_T_Soldier_AR_F", "U_B_CTRG_3", "U_B_GEN_Soldier_F", "U_B_GEN_Commander_F", "U_B_PilotCoveralls", "U_B_Wetsuit", "U_I_HeliPilotCoveralls", "U_B_CTRG_Soldier_urb_3_F", "U_B_CTRG_2", "U_B_SpecopsUniform_sgg", "U_O_T_Officer_F", "U_I_CombatUniform_tshirt", "U_I_CombatUniform", "U_O_T_Officer_F", "U_B_HeliPilotCoveralls", "U_O_CombatUniform_ocamo", "U_I_CombatUniform_shortsleeve", "U_O_T_Soldier_F", "U_B_CombatUniform_mcam_vest", "U_B_CTRG_Soldier_urb_1_F", "U_B_CombatUniform_mcam", "U_B_HeliPilotCoveralls", "U_O_SpecopsUniform_ocamo", "U_B_GEN_Commander_F", "U_B_CombatUniform_mcam_vest", "U_O_Wetsuit", "U_O_V_Soldier_Viper_hex_F", "U_B_CTRG_Soldier_F", "U_B_CTRG_Soldier_urb_3_F", "U_I_HeliPilotCoveralls", "U_I_CombatUniform_tshirt", "U_I_CombatUniform", "U_B_CTRG_2", "U_B_GEN_Soldier_F", "U_I_CombatUniform_shortsleeve", "U_O_SpecopsUniform_blk", "U_B_CTRG_1", "U_B_CombatUniform_mcam_worn", "U_I_CombatUniform_shortsleeve", "U_O_Wetsuit", "U_B_CTRG_Soldier_3_F", "U_B_CTRG_Soldier_urb_1_F", "U_B_SpecopsUniform_sgg", "U_O_PilotCoveralls", "U_O_SpecopsUniform_ocamo", "U_B_T_Soldier_AR_F", "U_O_CombatUniform_oucamo", "U_B_CTRG_Soldier_2_F", "U_B_CombatUniform_mcam", "U_B_CTRG_Soldier_2_F", "U_I_pilotCoveralls", "U_B_CTRG_3", "U_B_CTRG_Soldier_F", "U_B_CombatUniform_mcam", "U_B_CTRG_Soldier_urb_3_F", "U_B_CTRG_Soldier_urb_1_F", "U_B_Wetsuit", "U_B_CombatUniform_mcam_tshirt"};
		/*
		...
		*/
		MilitaryBackpacks[] = {"B_Bergen_tna_F", "B_Carryall_cbr", "B_Carryall_oli", "B_Bergen_mcamo_F", "B_Carryall_mcamo", "B_Carryall_oli", "B_Carryall_ocamo", "B_Carryall_cbr", "B_Bergen_hex_F", "B_Bergen_dgtl_F", "B_Carryall_khk", "B_Carryall_oucamo", "B_Carryall_ocamo", "B_Carryall_khk", "B_Carryall_mcamo", "B_Carryall_ghex_F", "B_Carryall_oucamo", "B_Bergen_Base_F", "B_Carryall_ghex_F"};
		/*
		...
		*/
		MilitaryVests[] = {"V_PlateCarrierGL_rgr", "V_PlateCarrierIA2_dgtl", "V_PlateCarrierSpec_rgr", "V_PlateCarrierGL_rgr", "V_PlateCarrierL_CTRG", "V_PlateCarrier2_rgr", "V_PlateCarrier1_rgr", "V_PlateCarrier1_rgr", "V_PlateCarrier1_blk", "V_PlateCarrierIA2_dgtl", "V_PlateCarrierIAGL_dgtl", "V_PlateCarrierSpec_rgr", "V_PlateCarrierIA1_dgtl", "V_PlateCarrier3_rgr", "V_PlateCarrier2_rgr", "V_PlateCarrier3_rgr", "V_PlateCarrierIA1_dgtl", "V_PlateCarrierIAGL_dgtl", "V_PlateCarrierH_CTRG", "V_PlateCarrier1_blk"};
		/*
		...
		*/
		MilitaryHeadgear[] = {"H_MilCap_blue", "H_MilCap_rucamo", "H_HelmetIA", "H_HelmetSpecB_paint1", "H_HelmetB_black", "H_HelmetB_light_black", "H_HelmetSpecO_blk", "H_HelmetLeaderO_ghex_F", "H_PilotHelmetHeli_B", "H_HelmetB_tna_F", "H_HelmetB_paint", "H_MilCap_rucamo", "Exile_Headgear_GasMask", "H_HelmetB_tna_F", "H_HelmetB_plain_blk", "H_HelmetB_light_black", "H_MilCap_mcamo", "H_HelmetB", "H_HelmetSpecB_paint2", "H_HelmetCrew_O", "H_HelmetB", "H_Helmet_Skate", "H_HelmetB_light_sand", "H_HelmetB_light_desert", "H_BandMask_reaper", "H_MilCap_dgtl", "H_HelmetIA", "H_HelmetCrew_O_ghex_F", "H_MilCap_ocamo", "H_HelmetB_Enh_tna_F", "H_HelmetSpecB_paint1", "H_BandMask_reaper", "H_HelmetB_light_sand", "H_HelmetB_snakeskin", "H_HelmetB_grass", "H_HelmetO_oucamo", "Exile_Headgear_GasMask", "H_HelmetB_light_grass", "H_HelmetB_sand", "H_BandMask_khk", "H_HelmetB_Light_tna_F", "H_HelmetLeaderO_ocamo", "H_HelmetIA_net", "H_HelmetCrew_O_ghex_F", "H_HelmetB_black", "H_MilCap_blue", "H_HelmetO_ocamo", "H_HelmetSpecB_blk", "H_HelmetSpecB", "H_PilotHelmetFighter_O", "H_HelmetSpecO_ghex_F", "H_MilCap_oucamo", "Exile_Headgear_GasMask", "H_HelmetSpecB_paint1", "H_HelmetSpecB_paint2", "H_CrewHelmetHeli_O", "H_HelmetB_paint", "H_MilCap_rucamo", "H_HelmetB_grass", "H_BandMask_demon", "H_MilCap_oucamo", "H_HelmetO_ghex_F", "H_HelmetSpecB_paint2", "H_PilotHelmetFighter_I", "H_PilotHelmetFighter_B", "H_HelmetSpecB_blk", "H_HelmetB_desert", "H_HelmetB_light_snakeskin", "H_MilCap_ocamo", "H_HelmetB_light_snakeskin", "H_HelmetSpecB", "H_HelmetB_paint", "H_Helmet_Skate", "H_CrewHelmetHeli_I", "H_HelmetSpecB_blk", "H_Beret_gen_F", "H_HelmetB_light_grass", "H_MilCap_dgtl", "H_HelmetIA_camo", "H_MilCap_blue", "H_HelmetLeaderO_oucamo", "H_HelmetB_plain_blk", "H_HelmetB_light", "H_HelmetB_light", "H_MilCap_dgtl", "H_HelmetSpecB", "H_MilCap_mcamo", "H_HelmetB_light", "H_MilCap_mcamo", "H_BandMask_khk", "H_CrewHelmetHeli_B", "H_HelmetB_light_desert", "H_MilCap_ocamo", "H_BandMask_demon", "H_MilCap_ocamo", "H_MilCap_blue", "H_HelmetB_sand", "H_HelmetCrew_I", "H_HelmetIA", "H_MilCap_oucamo", "H_HelmetSpecO_ghex_F", "H_MilCap_mcamo", "H_HelmetSpecO_ocamo", "H_HelmetB_Light_tna_F", "H_PilotHelmetHeli_O", "H_Beret_gen_F", "H_HelmetB_snakeskin", "H_HelmetB", "H_HelmetIA_net", "Exile_Headgear_GasMask", "H_MilCap_oucamo", "H_MilCap_rucamo", "H_HelmetIA_camo", "H_HelmetB_desert", "H_HelmetLeaderO_ghex_F", "H_HelmetB_TI_tna_F", "H_HelmetB_plain_blk", "H_MilCap_dgtl", "H_HelmetB_Enh_tna_F", "H_HelmetB_camo", "H_HelmetB_TI_tna_F", "H_PilotHelmetHeli_I", "H_HelmetCrew_B"};
		/*
		...
		*/
		DLCGhillies[] = {"U_B_T_Sniper_F", "U_B_T_Sniper_F", "U_B_FullGhillie_sard", "U_B_T_Soldier_F", "U_B_T_FullGhillie_tna_F", "U_O_T_Sniper_F", "U_O_T_FullGhillie_tna_F", "U_O_T_FullGhillie_tna_F", "U_B_T_Soldier_F", "U_O_T_Sniper_F", "U_B_T_FullGhillie_tna_F", "U_B_T_FullGhillie_tna_F", "U_B_T_FullGhillie_tna_F", "U_B_T_Sniper_F", "U_I_FullGhillie_ard", "U_O_T_Sniper_F", "U_O_FullGhillie_sard", "U_B_T_FullGhillie_tna_F", "U_B_T_Soldier_F", "U_I_FullGhillie_sard", "U_B_FullGhillie_lsh", "U_B_T_Soldier_F", "U_O_T_Sniper_F", "U_O_T_FullGhillie_tna_F", "U_B_FullGhillie_ard", "U_B_T_Sniper_F", "U_B_T_Sniper_F", "U_O_FullGhillie_ard", "U_O_T_FullGhillie_tna_F", "U_O_T_FullGhillie_tna_F", "U_I_FullGhillie_lsh", "U_O_T_Sniper_F", "U_O_FullGhillie_lsh", "U_B_T_Soldier_F"};
		/*
		...
		*/
		DLCVests[] = {"V_TacChestrig_grn_F", "V_PlateCarrier1_tna_F", "V_PlateCarrierGL_tna_F", "V_PlateCarrierGL_blk", "V_PlateCarrierSpec_rgr", "V_PlateCarrierSpec_blk", "V_PlateCarrierIAGL_oli", "V_TacChestrig_cbr_F", "V_PlateCarrierSpec_mtp", "V_PlateCarrierGL_mtp", "V_PlateCarrierSpec_tna_F", "V_HarnessO_ghex_F", "V_PlateCarrier2_rgr_noflag_F", "V_BandollierB_ghex_F", "V_HarnessOGL_ghex_F", "V_TacChestrig_oli_F", "V_PlateCarrierIAGL_dgtl", "V_PlateCarrierGL_rgr", "V_PlateCarrier1_rgr_noflag_F", "V_TacVest_gen_F", "V_PlateCarrier2_tna_F"};
		/*
			Percental Item Spawn Chances of Rebreathers:
			V_RebreatherB  = 33.33%
			V_RebreatherIR = 33.33%
		...
		*/
		MedicalItems[] = {"Exile_Item_Heatpack", "Exile_Item_Bandage", "Exile_Item_Heatpack", "Exile_Item_InstaDoc", "Exile_Item_Bandage", "Exile_Item_Vishpirin", "Exile_Item_Heatpack", "Exile_Item_Vishpirin", "Exile_Item_Heatpack", "Exile_Item_Vishpirin", "Exile_Item_Vishpirin"};
		/*
		...
		*/
		IndustrialItems[] = {"Exile_Item_Sand", "Exile_Item_JunkMetal", "Exile_Item_JunkMetal", "Exile_Item_ScrewDriver", "Exile_Melee_Axe", "Exile_Item_FloodLightKit", "Exile_Melee_Axe", "Exile_Item_Handsaw", "Exile_Melee_SledgeHammer", "Exile_Item_Grinder", "Exile_Item_Grinder", "Exile_Melee_Shovel", "Exile_Item_Pliers", "Exile_Item_MetalBoard", "Exile_Item_Sand", "Exile_Item_LightBulb", "Exile_Item_LightBulb", "Exile_Item_Pliers", "Exile_Item_ThermalScannerPro", "Exile_Item_CamoTentKit", "Exile_Item_ScrewDriver", "Exile_Melee_Axe", "Exile_Item_FloodLightKit", "Exile_Item_ScrewDriver", "Exile_Item_ScrewDriver", "Exile_Item_WaterCanisterEmpty", "Exile_Item_MetalScrews", "Exile_Item_ExtensionCord", "Exile_Item_CamoTentKit", "Exile_Item_JunkMetal", "Exile_Melee_Shovel", "Exile_Item_LightBulb", "Exile_Item_LightBulb", "Exile_Item_ExtensionCord", "Exile_Melee_Shovel", "Exile_Melee_SledgeHammer", "Exile_Melee_Axe", "Exile_Item_Handsaw", "Exile_Item_Cement", "Exile_Item_LightBulb", "Exile_Melee_Axe", "Exile_Melee_Axe", "Exile_Item_JunkMetal", "Exile_Melee_Axe", "Exile_Item_ScrewDriver", "Exile_Item_LightBulb", "Exile_Item_Handsaw", "Exile_Item_Pliers", "Exile_Melee_Axe", "Exile_Item_Handsaw", "Exile_Melee_Axe", "Exile_Item_JunkMetal", "Exile_Item_Pliers", "Exile_Item_Cement", "Exile_Item_Pliers", "Exile_Melee_Axe", "Exile_Item_Knife", "Exile_Item_PortableGeneratorKit", "Exile_Item_CamoTentKit", "Exile_Item_JunkMetal", "Exile_Item_Grinder", "Exile_Melee_Axe", "Exile_Item_PortableGeneratorKit", "Exile_Melee_Axe", "Exile_Item_Handsaw", "Exile_Item_Foolbox", "Exile_Item_Handsaw", "Exile_Item_ExtensionCord", "Exile_Item_Handsaw", "Exile_Item_Handsaw", "Exile_Item_Grinder", "Exile_Item_WaterCanisterEmpty", "Exile_Melee_Axe", "Exile_Item_Foolbox", "Exile_Item_ScrewDriver", "Exile_Item_JunkMetal", "Exile_Melee_Shovel", "Exile_Melee_Shovel", "Exile_Melee_Axe", "Exile_Melee_Axe", "Exile_Item_LightBulb", "Exile_Item_WaterCanisterEmpty", "Exile_Item_JunkMetal", "Exile_Item_ExtensionCord", "Exile_Item_JunkMetal", "Exile_Item_Foolbox", "Exile_Item_JunkMetal", "Exile_Melee_SledgeHammer", "Exile_Item_WaterCanisterEmpty", "Exile_Item_Handsaw", "Exile_Item_MetalBoard", "Exile_Item_ExtensionCord", "Exile_Item_Pliers", "Exile_Item_LightBulb", "Exile_Item_WaterCanisterEmpty", "Exile_Melee_Axe", "Exile_Item_PortableGeneratorKit", "Exile_Item_Pliers", "Exile_Item_CamoTentKit", "Exile_Item_Pliers", "Exile_Item_WaterCanisterEmpty", "Exile_Item_ScrewDriver", "Exile_Item_ExtensionCord", "Exile_Melee_Shovel", "Exile_Item_ScrewDriver", "Exile_Item_Pliers", "Exile_Item_FloodLightKit", "Exile_Item_Sand", "Exile_Item_WaterCanisterEmpty", "Exile_Melee_Axe", "Exile_Item_ScrewDriver", "Exile_Item_Sand", "Exile_Melee_Shovel", "Exile_Item_ExtensionCord", "Exile_Item_WaterCanisterEmpty", "Exile_Item_MetalBoard", "Exile_Item_Pliers", "Exile_Item_Grinder", "Exile_Item_WaterCanisterEmpty", "Exile_Item_Cement", "Exile_Item_Handsaw", "Exile_Item_Handsaw", "Exile_Melee_SledgeHammer", "Exile_Item_MetalBoard", "Exile_Melee_Shovel", "Exile_Item_ExtensionCord", "Exile_Melee_Axe", "Exile_Item_WaterCanisterEmpty", "Exile_Melee_Shovel", "Exile_Item_LightBulb", "Exile_Item_Pliers", "Exile_Item_MetalScrews", "Exile_Item_JunkMetal", "Exile_Item_Handsaw", "Exile_Item_Pliers", "Exile_Item_MetalScrews", "Exile_Melee_Axe", "Exile_Item_ScrewDriver", "Exile_Melee_Axe", "Exile_Melee_Axe", "Exile_Melee_SledgeHammer", "Exile_Item_Pliers", "Exile_Item_MetalScrews", "Exile_Item_Knife", "Exile_Item_Handsaw", "Exile_Item_ScrewDriver", "Exile_Item_ScrewDriver", "Exile_Melee_Shovel", "Exile_Item_Foolbox", "Exile_Item_MetalScrews", "Exile_Item_ScrewDriver", "Exile_Melee_Axe"};
		/*
		...
		*/
		Vehicle[] = {"Exile_Item_FuelCanisterEmpty", "Exile_Item_FuelCanisterEmpty", "Exile_Item_FuelCanisterEmpty", "Exile_Item_FuelCanisterFull", "Exile_Item_FuelCanisterFull", "Exile_Item_FuelCanisterFull", "Exile_Item_FuelCanisterEmpty", "Exile_Item_FuelCanisterEmpty", "Exile_Item_FuelCanisterFull", "Exile_Item_DuctTape"};
		/*
		...
		*/
		...
		/*
			...
			SmokeShellOrange = 14.29%
		*/
		SmokeGrenades[] = {"SmokeShellOrange", "SmokeShellYellow", "SmokeShellPurple", "SmokeShell", "SmokeShellGreen", "SmokeShellRed", "SmokeShellBlue"};
		/*
		...
		*/
		Trash[] = {"Exile_Item_Can_Empty", "Exile_Item_PlasticBottleEmpty", "Exile_Item_ToiletPaper", "Exile_Item_Magazine01", "Exile_Item_Magazine03", "Exile_Item_ToiletPaper", "Exile_Item_PlasticBottleEmpty", "Exile_Item_Can_Empty", "Exile_Item_Magazine02", "Exile_Item_ToiletPaper", "Exile_Item_ToiletPaper", "Exile_Item_PlasticBottleEmpty", "Exile_Item_Magazine04", "Exile_Item_PlasticBottleEmpty", "Exile_Item_Can_Empty", "Exile_Item_Can_Empty"};
		/*
		...
		*/
		Unused[] = {"Exile_Item_CordlessScrewdriver", "Exile_Item_Rope", "Exile_Item_SleepingMat", "Exile_Item_Hammer", "Exile_Item_Defibrillator", "Exile_Item_Wrench", "Exile_Item_OilCanister", "Exile_Item_FireExtinguisher", "Exile_Item_Carwheel"};
	};
};
class CfgRewards
{
...
class BambiSettings
{
	 ...
	 */
	// Players will get what they need from the first mission. :)
	class loadOut{
		/*Guard[] = {
			"ExileLife_Weapon_Taser",
			"ExileLife_Item_TaserCartridge","ExileLife_Item_TaserCartridge","ExileLife_Item_TaserCartridge"
		};*/
	};
	/**
...
enabledEscapeEvents[] = {"EscapeSupplyBox", "AmbientFlyOver"/*, "EarthQuake"*/};
	...
	//configFile >> "CfgSettings" >> "GarbageCollector" >> "Ingame" >> "GroundVehicleHolder" >> "lifeTime")
///////////////////////////////////////////////////////////////////////
// KILLFEED MAN!
///////////////////////////////////////////////////////////////////////
class KillFeed
...
class Respect
{
	...
	*
	* Default: Get 1 respect for every 20 pop tabs
	*/
	...
	*/
	...
	/**
	* Defines the the minimum amount of Respect earned/lost for killing a rogue player (if your in a gang)
	*/
	killingRoguesMinRespectTransfer = 10;
	/**
	* Defines the the minimum amount of Respect earned/lost for killing a gang member (if your a rogue)
	*/
	rogueKillingGangMembersMinRespectTransfer = 80;
	/**
	...
	*/
	class Frags
	{
		...
		badass = 500;				// Rogue player killing gang members in their own territory
		itswar = 300;				// Warring gang members killing each other
		pwnd = 300;					//killing someone with a tazer
	};
	class Percentages
	{
		...
		safeNSound = 2; //Killing someone from the safety of your territory while they are not in it
		campingTerritory = 2; //Camping an enemy territory is cowardly and will cost you 2% of your respect!
		friendyFire = 5; // Friendly fire costs you 5%
...
class ServerSettings
{
	...
	*/
	serverFSM = "exilelife_server\fsm\main.fsm";
	/*
	...
	*/
	...
	devs[] =
	{
		//these are set just for us to be able to more easily test code etc
		{"76561198048317094","[EXILELIFE|DEV] Happydayz"},
		{"76561198037177305","[EXILELIFE|DEV] Wolfkillarcadia"}
	};
};
///////////////////////////////////////////////////////////////////////
