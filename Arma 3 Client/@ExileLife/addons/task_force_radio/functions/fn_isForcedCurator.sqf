...
if (isNil "_result") then {
	_result = ((typeof _this) == "VirtualCurator_F") || ([configFile >> "CfgVehicles" >> (typeof _this), configFile >> "CfgVehicles" >> "VirtualCurator_F"] call ExileLifeClient_util_config_inherits);
