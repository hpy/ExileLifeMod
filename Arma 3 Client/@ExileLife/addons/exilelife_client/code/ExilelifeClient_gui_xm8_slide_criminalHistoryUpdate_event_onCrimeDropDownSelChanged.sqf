/**
                    * ExilelifeClient_gui_xm8_slide_criminalHistoryUpdate_event_onCrimeDropDownSelChanged
                    *
                    * ExileLife Mod
...
_fineCtrl = _display displayCtrl 5323;
_jailCtrl = _display displayCtrl 5324;
