/**
                    * ExilelifeClient_object_item_checkOptionsVictim
                    *
                    * ExileLife Mod
                    ...
                    */
                    ...
                    private["_config","_victim","_feedbackString","_chance","_dice","_skillRequired","_skillName","_skillLevelReq","_skillLevel","_tools","_equippedMagazines","_toolItemClassName","_equippedToolQuantity","_stopBleeding","_animations","_animationIndex","_configSounds","_numberOfConfigSounds","_successFunction","_successArguments","_successType","_code","_successNotification"];
...
try{
	...
	{
		if (getBleedingRemaining _victim > 0) then 
		{
			_victim setBleedingRemaining 0; 
			_victim setVariable ['ExileLifeClientBleeding',false,true];
			_victim setVariable ['ExileLifeClientPlayerIsBleeding',false,true];
		};
	};
