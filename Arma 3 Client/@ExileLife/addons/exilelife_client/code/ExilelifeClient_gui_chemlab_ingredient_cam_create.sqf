/**
                    * ExilelifeClient_gui_chemlab_ingredient_cam_create
                    *
                    * ExileLife Mod
...
_mixingCamAimPosModel  = ExileClientInteractionObject selectionPosition ["ingredient", "memory"];
...
call ExileLifeClient_gui_chemlab_ingredient_show;
