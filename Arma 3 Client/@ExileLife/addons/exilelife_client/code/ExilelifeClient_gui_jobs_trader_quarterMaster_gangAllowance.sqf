/**
                    * ExilelifeClient_gui_jobs_trader_quarterMaster_gangAllowance
                    *
                    * ExileLife Mod
...
if (ExileLifeClientGangAllowance < 1) then 
{
...
else
{
	...
	_priceText = format ["<br/><br/><br/><t shadow='0' align='left'  size='1.2'>Awaiting Collection:   %1<img image='\exile_assets\texture\ui\poptab_notification_ca.paa' size='1' shadow='true' /></t>",ExileLifeClientGangAllowance];
	_text = parseText format
	[
