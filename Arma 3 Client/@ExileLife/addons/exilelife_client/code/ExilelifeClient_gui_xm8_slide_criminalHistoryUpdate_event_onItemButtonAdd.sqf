/**
                    * ExilelifeClient_gui_xm8_slide_criminalHistoryUpdate_event_onItemButtonAdd
                    *
                    * ExileLife Mod
...
_itemsInputCtrl = _display displayCtrl 5318;
_itemsQuantityCtrl = _display displayCtrl 5333;
