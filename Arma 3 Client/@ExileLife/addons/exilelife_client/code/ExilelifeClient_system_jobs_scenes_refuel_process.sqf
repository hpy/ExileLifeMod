/**
                    * ExilelifeClient_system_jobs_scenes_refuel_process
                    *
                    * ExileLife Mod
...
{
	if (((ExileLifeCurrentJob select 0) find "refuel") > -1) then
	{
		_hasBarrel = false;
		_full = false;
		{
...
{
	["InfoTitleOnly",["It doesn't need fuel at the moment"]] call ExileClient_gui_toaster_addTemplateToast;
};