/**
                    * ExileClientOverwrites_gui_traderDialog_updateStoreListBox
                    *
                    * Exile Mod
                    * www.exilemod.com
                    * © 2016 Exile Mod Team
