/**
                    * ExileClientOverwrites_object_player_stats_updateTemperature
                    *
                    * Exile Mod
                    * www.exilemod.com
                    * © 2016 Exile Mod Team
...
{
	[player,(ExileLifeClientPlayerDamage + 0.1/60*_timeElapsed)] call ExileLifeClient_util_health_damageAllHitpoints;
};
